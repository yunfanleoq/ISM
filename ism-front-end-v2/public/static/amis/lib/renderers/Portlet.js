...
var Portlet = /** @class */ (function (_super) {
    ...
    Portlet.prototype.renderToolbar = function () {
        ...
        // tabs里的toolbar
        var toolbarTpl = toolbar ? (_J$X_("div", { className: cx("".concat(ns, "toolbar")) }, this.renderToolbarItem(toolbar))) : null;
        // tab里的toolbar
        if (typeof activeKey !== 'undefined') {
            tabToolbar = tabs[activeKey].toolbar;
            tabToolbarTpl = tabToolbar ? (_J$X_("div", { className: cx("".concat(ns, "tab-toolbar")) }, this.renderToolbarItem(tabToolbar))) : null;
        }
        return toolbarTpl || tabToolbarTpl ? (_J$X_("div", { className: cx("".concat(ns, "Portlet-toolbar")) },
            toolbarTpl,
            tabToolbarTpl)) : null;
    };
    Portlet.prototype.renderDesc = function () {
        ...
        return desc ? (_J$X_("span", { className: cx("".concat(ns, "Portlet-header-desc")) }, desc)) : null;
    };
    Portlet.prototype.renderTabs = function () {
        ...
        if (Array.isArray(arr)) {
            arr.forEach(function (value, index) {
                ...
                children.push.apply(children, tslib.__spreadArray([], tslib.__read(tabs.map(function (tab, tabIndex) {
                    return amisCore.isVisible(tab, ctx) ? (_J$X_(amisUi.Tab, tslib.__assign({}, tab, { title: amisCore.filter(tab.title, ctx), disabled: amisCore.isDisabled(tab, ctx), key: "".concat(index * 1000 + tabIndex), eventKey: index * 1000 + tabIndex, mountOnEnter: mountOnEnter, unmountOnExit: typeof tab.reload === 'boolean'
                            ? tab.reload
            ...
            children = tabs.map(function (tab, index) {
                return amisCore.isVisible(tab, data) ? (_J$X_(amisUi.Tab, tslib.__assign({}, tab, { title: amisCore.filter(tab.title, data), disabled: amisCore.isDisabled(tab, data), key: index, eventKey: index, mountOnEnter: mountOnEnter, unmountOnExit: typeof tab.reload === 'boolean'
                        ? tab.reload
                        : typeof tab.unmountOnExit === 'boolean'
                            ? tab.unmountOnExit
    ...
    Portlet.prototype.render = function () {
        ...
        return (_J$X_("div", { className: portletClassname, style: styleVar }, this.renderTabs()));
    };
