...
var ImageField = /** @class */ (function (_super) {
    ...
    ImageField.prototype.handleEnlarge = function (_a) {
        ...
        onImageEnlarge &&
            onImageEnlarge({
                ...
                imageGallaryClassName: "".concat(imageGallaryClassName, " ").concat(amisCore.setThemeClassName(tslib.__assign(tslib.__assign({}, this.props), { name: 'imageGallaryClassName', id: id, themeCss: themeCss })), " ").concat(amisCore.setThemeClassName(tslib.__assign(tslib.__assign({}, this.props), { name: 'galleryControlClassName', id: id, themeCss: themeCss })))
            }, this.props);
    };
    ...
    ImageField.prototype.render = function () {
        ...
        return (_J$X_("div", { className: cx('ImageField', imageMode === 'original'
                ? 'ImageField--original'
                : 'ImageField--thumb', className, amisCore.setThemeClassName(tslib.__assign(tslib.__assign({}, this.props), { name: 'wrapperCustomStyle', id: id, themeCss: wrapperCustomStyle }))), style: tslib.__assign(tslib.__assign({}, style), { transform: "scale(".concat(this.state.scale, ")") }), onClick: this.handleClick, onMouseEnter: this.handleMouseEnter, onMouseLeave: this.handleMouseLeave },
            value || (!value && !placeholder) ? (_J$X_(ThemedImageThumb, { className: innerClassName, imageClassName: imageClassName, thumbClassName: thumbClassName, height: height, width: width, src: value ? value : defaultValue, href: finnalHref, title: amisCore.filter(title, data), caption: amisCore.filter(imageCaption, data), thumbMode: thumbMode, thumbRatio: thumbRatio, originalSrc: (_a = amisCore.filter(originalSrc, data, '| raw')) !== null && _a !== void 0 ? _a : value, enlargeAble: enlargeAble && value && value !== defaultValue, onEnlarge: this.handleEnlarge, imageMode: imageMode, imageControlClassName: amisCore.setThemeClassName(tslib.__assign(tslib.__assign({}, this.props), { name: 'imageControlClassName', id: id, themeCss: themeCss })), titleControlClassName: amisCore.setThemeClassName(tslib.__assign(tslib.__assign({}, this.props), { name: 'titleControlClassName', id: id, themeCss: themeCss })), desControlClassName: amisCore.setThemeClassName(tslib.__assign(tslib.__assign({}, this.props), { name: 'desControlClassName', id: id, themeCss: themeCss })), iconControlClassName: amisCore.setThemeClassName(tslib.__assign(tslib.__assign({}, this.props), { name: 'iconControlClassName', id: id, themeCss: themeCss })) })) : (_J$X_("span", { className: "text-muted" }, placeholder)),
