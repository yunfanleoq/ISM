...
export default class CRUD extends React.Component<CRUDProps, any> {
    ...
    handleQuery(values: object, forceReload?: boolean, replace?: boolean, resetPage?: boolean, clearSelection?: boolean): void;
    reload(subpath?: string, query?: any, replace?: boolean, resetPage?: boolean): void;
    receive(values: object, subPath?: string, replace?: boolean, resetPage?: boolean, clearSelection?: boolean): void;
    ...
    renderToolbar(toolbar?: SchemaNode, index?: number, childProps?: any, toolbarRenderer?: (toolbar: SchemaNode, index: number) => React.ReactNode): string | number | boolean | JSX.Element | Iterable<React.ReactNode> | null;
    renderHeaderToolbar(childProps: any, toolbarRenderer?: (toolbar: SchemaNode, index: number) => React.ReactNode): string | number | boolean | JSX.Element | Iterable<React.ReactNode> | null;
    renderFooterToolbar(childProps: any, toolbarRenderer?: (toolbar: SchemaNode, index: number) => React.ReactNode): string | number | boolean | JSX.Element | Iterable<React.ReactNode> | null;
...
export declare class CRUDRenderer extends CRUD {
    ...
    receive(values: any, subPath?: string, replace?: boolean, resetPage?: boolean, clearSelection?: boolean): void;
    reloadTarget(target: string, data: any): void;
    closeTarget(target: string): void;
    setData(values: {
        items?: any[];
