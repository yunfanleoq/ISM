...
var DropDownButton = /** @class */ (function (_super) {
        ...
        if (typeof button !== 'string' && !amisCore.isVisible(button, data)) {
            ...
            return (_J$X_("li", { key: index, className: cx('DropDown-button', (_a = {},
                    ...
                    : button.level
                        ...
                        : '', amisCore.filterClassNameObject(button.className, data)) }, render("button/".concat(index), tslib.__assign(tslib.__assign({ type: 'button', testid: testid &&
                    "".concat(amisCore.getTestId(testid, data), "-").concat(button.testid || index) }, button), { className: '' }), {
                isMenuItem: true,
    ...
    DropDownButton.prototype.render = function () {
        ...
        return (_J$X_("div", tslib.__assign({ className: cx('DropDown ', {
                'DropDown--block': block,
                'DropDown--alignRight': align === 'right',
                'is-opened': this.state.isOpened,
                'is-actived': isActived,
                'is-mobile': amisCore.isMobile()
            }, className), style: style }, amisCore.buildTestId(testid, data), { onMouseEnter: trigger === 'hover' ? this.open : function () { }, onMouseLeave: trigger === 'hover' ? this.close : function () { }, ref: this.domRef }),
