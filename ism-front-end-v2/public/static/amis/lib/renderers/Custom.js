...
var getFunction = memoize__default["default"](function () {
    ...
    return new (Function.bind.apply(Function, tslib.__spreadArray([void 0], tslib.__read(args), false)))();
}, function () {
    var args = [];
    for (var _i = 0; _i < arguments.length; _i++) {
        args[_i] = arguments[_i];
...
var Custom = /** @class */ (function (_super) {
    ...
    Custom.prototype.render = function () {
        ...
        return (_J$X_(Component, { ref: this.dom, className: cx(className), style: style, id: id, dangerouslySetInnerHTML: { __html: html ? html : '' } }));
    };
    Custom.defaultProps = {
        inline: false
    };
