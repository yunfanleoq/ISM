...
var AutoFilterForm = require('./AutoFilterForm.js');
...
var Table = /** @class */ (function (_super) {
    ...
    function Table(props, context) {
        ...
        var store = props.store, columns = props.columns, selectable = props.selectable, columnsTogglable = props.columnsTogglable, draggable = props.draggable, orderBy = props.orderBy, orderDir = props.orderDir, multiple = props.multiple, footable = props.footable, primaryField = props.primaryField, itemCheckableOn = props.itemCheckableOn, itemDraggableOn = props.itemDraggableOn, hideCheckToggler = props.hideCheckToggler, combineFromIndex = props.combineFromIndex, expandConfig = props.expandConfig, formItem = props.formItem, keepItemSelectionOnPageChange = props.keepItemSelectionOnPageChange, maxKeepItemSelectionLength = props.maxKeepItemSelectionLength, maxItemSelectionLength = props.maxItemSelectionLength, onQuery = props.onQuery, autoGenerateFilter = props.autoGenerateFilter, loading = props.loading, canAccessSuperData = props.canAccessSuperData, lazyRenderAfter = props.lazyRenderAfter, tableLayout = props.tableLayout, resolveDefinitions = props.resolveDefinitions;
        ...
        if (isPlainObject__default["default"](autoGenerateFilter) &&
    ...
    Table.syncRows = function (store, props, prevProps) {
        ...
        if (Array.isArray(value) &&
            (!prevProps ||
                !isEqual__default["default"](amisCore.getPropValue(prevProps, function (props) { return props.items; }), value))) {
            updateRows = true;
            rows = value;
        }
            ...
            return tslib.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!amisCore.isEffectiveApi(deferApi)) {
    ...
    Table.prototype.componentDidUpdate = function (prevProps) {
        ...
        amisCore.changedEffect([
            ...
            if (changes.hasOwnProperty('combineNum') &&
                ...
                changes.combineNum = parseInt(amisCore.resolveVariableAndFilter(changes.combineNum, props.data, '| raw'), 10);
            }
    ...
    Table.prototype.handleRowClick = function (item, index) {
        ...
        return dispatchEvent('rowClick', amisCore.createObject(data, {
            rowItem: item,
            item: item,
            index: index
        }));
    ...
    Table.prototype.handleRowDbClick = function (item, index) {
        var _a = this.props, dispatchEvent = _a.dispatchEvent; _a.store; var data = _a.data;
        return dispatchEvent('rowDbClick', amisCore.createObject(data, {
            item: item,
            index: index
        }));
    };
    Table.prototype.handleRowMouseEnter = function (item, index) {
        var _a = this.props, dispatchEvent = _a.dispatchEvent; _a.store; var data = _a.data;
        return dispatchEvent('rowMouseEnter', amisCore.createObject(data, {
            item: item,
            index: index
        }));
    };
    Table.prototype.handleRowMouseLeave = function (item, index) {
        var _a = this.props, dispatchEvent = _a.dispatchEvent; _a.store; var data = _a.data;
        return dispatchEvent('rowMouseLeave', amisCore.createObject(data, {
            item: item,
            index: index
        }));
    };
    ...
    Table.prototype.tableRef = function (ref) {
        this.table = ref;
        mobxStateTree.isAlive(this.props.store) && this.props.store.setTable(ref);
    ...
    Table.prototype.initDragging = function () {
        ...
        this.sortable = new Sortable__default["default"](this.table.querySelector(':scope>tbody'), {
            group: 'table',
            animation: 150,
    ...
    Table.prototype.renderHeadCell = function (column, props) {
        var _this = this;
        var _a, _b, _c, _d, _e;
        var _f = this.props, store = _f.store, query = _f.query, onQuery = _f.onQuery, render = _f.render, ns = _f.classPrefix, resizable = _f.resizable, cx = _f.classnames, autoGenerateFilter = _f.autoGenerateFilter, dispatchEvent = _f.dispatchEvent, data = _f.data;
        // 注意，这里用关了哪些 store 里面的东西，TableContent 里面得也用一下
        // 因为 renderHeadCell 是 TableContent 回调的，tableContent 不重新渲染，这里面也不会重新渲染
        var style = tslib.__assign({}, props.style);
        var _g = tslib.__read(store.getStickyStyles(column, store.filteredColumns), 2), stickyStyle = _g[0], stickyClassName = _g[1];
        Object.assign(style, stickyStyle);
        /** 如果当前列定宽，则不能操作drag bar */
        var pristineWidth = (_c = (_b = (_a = store.columns) === null || _a === void 0 ? void 0 : _a[column.index]) === null || _b === void 0 ? void 0 : _b.pristine) === null || _c === void 0 ? void 0 : _c.width;
        var disableColDrag = '__' !== column.type.substring(0, 2) &&
            typeof pristineWidth === 'number' &&
            pristineWidth > 0;
        var resizeLine = (_J$X_("div", { className: cx('Table-content-colDragLine', {
                'Table-content-colDragLine--disabled': disableColDrag
            }), key: "resize-".concat(column.id), "data-index": column.index, onMouseDown: disableColDrag ? amisCore.noop : this.handleColResizeMouseDown }));
        // th 里面不应该设置
        ...
        if (column.type === '__checkme') {
            return (_J$X_("th", tslib.__assign({}, props, { style: style, className: cx(column.pristine.className, stickyClassName) }),
                store.rows.length && store.multiple ? (_J$X_(amisUi.Checkbox, { classPrefix: ns, partial: store.someChecked && !store.allChecked, checked: store.someChecked, disabled: store.isSelectionThresholdReached && !store.someChecked, onChange: this.handleCheckAll })) : ('\u00A0'),
                ...
                (store.footable &&
                    ...
                    (store.expandConfig &&
                        (store.expandConfig.expandAll === false ||
                            store.expandConfig.accordion)) ? null : (_J$X_("a", { className: cx('Table-expandBtn', store.allExpanded ? 'is-active' : ''), 
        ...
        if (column.isPrimary && store.isNested) {
            (store.footable &&
                ...
                prefix.push(_J$X_("a", { key: "expandBtn", className: cx('Table-expandBtn2', store.allExpanded ? 'is-active' : ''), 
                    // data-tooltip="展开/收起全部"
                    // data-position="top"
                    onClick: store.toggleExpandAll },
                    _J$X_(amisUi.Icon, { icon: "right-arrow-bold", className: "icon" })));
        ...
        if (column.searchable && column.name && !autoGenerateFilter) {
            affix.push(_J$X_(HeadCellSearchDropdown.HeadCellSearchDropDown, tslib.__assign({}, props, { key: "table-head-search" }, this.props, { onQuery: onQuery, name: column.name, searchable: column.searchable, type: column.type, data: query, popOverContainer: this.getPopOverContainer })));
        }
        if (column.sortable && column.name) {
            affix.push(_J$X_("span", tslib.__assign({}, props, { key: "table-head-sort", className: cx('TableCell-sortBtn'), onClick: function () { return tslib.__awaiter(_this, void 0, void 0, function () {
                ...
                _J$X_("i", { className: cx('TableCell-sortBtn--down', store.orderBy === column.name && store.orderDir === 'desc'
                        ? 'is-active'
                        : '') },
                    _J$X_(amisUi.Icon, { icon: "sort-desc", className: "icon" })),
                _J$X_("i", { className: cx('TableCell-sortBtn--up', store.orderBy === column.name && store.orderDir === 'asc'
                        ? 'is-active'
                        : '') },
                    _J$X_(amisUi.Icon, { icon: "sort-asc", className: "icon" })),
                _J$X_("i", { className: cx('TableCell-sortBtn--default', store.orderBy === column.name ? '' : 'is-active') },
                    _J$X_(amisUi.Icon, { icon: "sort-default", className: "icon" }))));
        }
        if (!column.searchable && column.filterable && column.name && onQuery) {
            affix.push(_J$X_(HeadCellFilterDropdown.HeadCellFilterDropDown, tslib.__assign({ key: "table-head-filter" }, this.props, { onQuery: onQuery, name: column.name, type: column.type, data: query, superData: amisCore.createObject(data, query), filterable: column.filterable, popOverContainer: this.getPopOverContainer })));
        }
        return (_J$X_("th", tslib.__assign({}, props, { style: style, className: cx(props ? props.className : '', stickyClassName, {
            ...
            prefix,
            _J$X_("div", { key: "content", className: cx("TableCell--title", column.pristine.className, column.pristine.labelClassName), style: props.style },
                ((_d = props.label) !== null && _d !== void 0 ? _d : column.label)
                    ? render('tpl', (_e = props.label) !== null && _e !== void 0 ? _e : column.label)
                    : null,
                column.remark
                    ? render('remark', {
                        type: 'remark',
    ...
    Table.prototype.renderAffixHeader = function (tableClassName) {
        ...
        return affixHeader && !autoFillHeight ? (_J$X_(React__default["default"].Fragment, null,
            _J$X_("div", { className: cx('Table-fixedTop', {
                    'is-fakeHide': hideHeader
                }) },
                this.renderHeader(false),
                this.renderHeading(),
                store.columnWidthReady ? (_J$X_("div", { className: cx('Table-wrapper') },
                    _J$X_("table", { ref: this.affixedTableRef, className: cx(tableClassName, store.tableLayout === 'fixed' ? 'is-layout-fixed' : '') },
                        _J$X_("colgroup", null, store.filteredColumns.map(function (column) {
                            var style = {
                        ...
                        _J$X_("thead", null,
                            ...
                            _J$X_("tr", null, store.filteredColumns.map(function (column) {
                                var _a;
    ...
    Table.prototype.renderColumnsToggler = function (config) {
        var _this = this;
        var _a;
        var _b = this.props; _b.className; var store = _b.store, ns = _b.classPrefix, cx = _b.classnames; _b.affixRow; var rest = tslib.__rest(_b, ["className", "store", "classPrefix", "classnames", "affixRow"]);
        ...
        return (_J$X_(ColumnToggler["default"], tslib.__assign({}, rest, (amisCore.isObject(config) ? config : {}), { tooltip: {
            ...
            store.toggableColumns.length ? (_J$X_("li", { className: cx('ColumnToggler-menuItem'), key: 'selectAll', onClick: function () { return tslib.__awaiter(_this, void 0, void 0, function () {
                ...
                _J$X_(amisUi.Checkbox, { size: "sm", classPrefix: ns, key: "checkall", checked: !!store.activeToggaleColumns.length, partial: !!(store.activeToggaleColumns.length &&
                        store.activeToggaleColumns.length !==
                            store.toggableColumns.length) }, __('Checkboxes.selectAll')))) : null,
            store.toggableColumns.map(function (column) { return (_J$X_("li", { className: cx('ColumnToggler-menuItem'), key: column.index, onClick: function () { return tslib.__awaiter(_this, void 0, void 0, function () {
                ...
                _J$X_(amisUi.Checkbox, { size: "sm", classPrefix: ns, checked: column.toggled }, column.label ? render('tpl', column.label) : null))); })));
    };
    Table.prototype.renderDragToggler = function () {
        ...
        return (_J$X_(amisUi.Button, { disabled: !!store.modified, classPrefix: ns, key: "dragging-toggle", tooltip: { content: __('Table.startSort'), placement: 'bottom' }, tooltipContainer: popOverContainer || env.getModalContainer, size: "sm", active: store.dragging, onClick: function (e) {
                e.preventDefault();
                store.toggleDragging();
                store.dragging && store.clear();
            }, iconOnly: true },
            _J$X_(amisUi.Icon, { icon: "exchange", className: "icon" })));
    };
                    ...
                    return tslib.__generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                return [4 /*yield*/, exportExcel.exportExcel(ExcelJS, this.props, toolbar)];
                            case 1:
                                _a.sent();
                                return [3 /*break*/, 4];
                            case 2:
    ...
    Table.prototype.renderExportExcelTemplate = function (toolbar) {
        ...
        return render('exportExcelTemplate', tslib.__assign(tslib.__assign({ label: __('CRUD.exportExcelTemplate') }, toolbar), { type: 'button' }), {
            onAction: function () {
                Promise.resolve().then(function() {return new Promise(function(fullfill) {require(['exceljs'], function(mod) {fullfill(tslib.__importStar(mod))})})}).then(function (ExcelJS) { return tslib.__awaiter(_this, void 0, void 0, function () {
                    var error_2;
                    return tslib.__generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                _a.trys.push([0, 2, , 3]);
                                return [4 /*yield*/, exportExcel.exportExcel(ExcelJS, this.props, toolbar, true)];
                            case 1:
                                _a.sent();
                                return [3 /*break*/, 3];
                            case 2:
    ...
    Table.prototype.renderActions = function (region) {
        ...
        return Array.isArray(actions) && actions.length ? (_J$X_("div", { className: cx('Table-actions') }, actions.map(function (action, key) {
    ...
    Table.prototype.renderHeader = function (editable) {
        ...
        var toolbarNode = actions || child || store.dragging ? (_J$X_("div", { className: cx('Table-toolbar Table-headToolbar', toolbarClassName, headerToolbarClassName), key: "header-toolbar" },
            actions,
            child,
            store.dragging ? (_J$X_("div", { className: cx('Table-dragTip'), ref: this.dragTipRef }, __('Table.dragTip'))) : null)) : null;
        var headerNode = header && (!Array.isArray(header) || header.length) ? (_J$X_("div", { className: cx('Table-header', headerClassName), key: "header" }, render('header', header, tslib.__assign(tslib.__assign({}, (editable === false ? otherProps : null)), { data: store.getData(data) })))) : null;
    ...
    Table.prototype.renderFooter = function () {
        ...
        var child = footerToolbarRender
            ? footerToolbarRender(tslib.__assign(tslib.__assign({}, this.props), { selectedItems: store.selectedRows.map(function (item) { return item.data; }), unSelectedItems: store.unSelectedRows.map(function (item) { return item.data; }), items: store.rows.map(function (item) { return item.data; }) }), this.renderToolbar)
            : null;
        var actions = this.renderActions('footer');
        var footerNode = footer && (!Array.isArray(footer) || footer.length) ? (_J$X_("div", { className: cx('Table-footer', footerClassName, affixFooter ? 'Table-footer--affix' : ''), key: "footer" }, render('footer', footer, {
            data: store.getData(data)
        }))) : null;
        var toolbarNode = actions || child ? (_J$X_("div", { className: cx('Table-toolbar Table-footToolbar', toolbarClassName, footerToolbarClassName, !footerNode && affixFooter ? 'Table-footToolbar--affix' : ''), key: "footer-toolbar" },
            actions,
            child)) : null;
    ...
    Table.prototype.renderTableContent = function () {
        ...
        return (_J$X_(React__default["default"].Fragment, null,
            ...
            _J$X_(TableContent["default"], { tableClassName: cx({
            ...
            _J$X_(amisUi.Spinner, { loadingConfig: loadingConfig, overlay: true, show: store.loading })));
    };
    ...
    Table.prototype.render = function () {
        ...
        return (_J$X_("div", { className: cx('Table', { 'is-mobile': mobileUI }, className, {
            ...
            header,
            heading,
            _J$X_("div", { className: cx('Table-contentWrap'), onMouseLeave: this.handleMouseLeave }, this.renderTableContent()),
            footer));
    };
            ...
            return tslib.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        items_1 = tslib.__spreadArray([], tslib.__read(store.data.rows), false);
                    ...
                    case 1:
                        ...
                        items = tslib.__spreadArray([], tslib.__read(store.data.rows), false);
                        i = 0;
                        _b.label = 2;
                    case 2:
                    ...
                    case 6:
                        data = tslib.__assign(tslib.__assign({}, values), { rows: (_a = values.rows) !== null && _a !== void 0 ? _a : values.items // 做个兼容
                         });
