...
function Cell(_a) {
    ...
    if (column.type === '__checkme') {
        return (_J$X_("td", { style: style, className: cx(column.pristine.className, stickyClassName) },
        ...
        return (_J$X_("td", { style: style, className: cx(column.pristine.className, stickyClassName) }, item.expandable ? (_J$X_("a", { className: cx('Table-expandBtn', item.expanded ? 'is-active' : ''), 
            // data-tooltip="展开/收起"
            // data-position="top"
