        ...
        return tslib.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    sourceValue = source;
                    if (!amisCore.isPureVariable(source)) return [3 /*break*/, 1];
        ...
        return tslib.__generator(this, function (_m) {
            switch (_m.label) {
                case 0:
                    ...
                    ctx = amisCore.createObject(data, tslib.__assign(tslib.__assign({}, props.query), (_g = {}, _g[pageField] = data.page || 1, _g[perPageField] = data.perPage || 10, _g)));
                                    ...
                                    if (typeof value !== 'undefined' && map && ((_c = map[value]) !== null && _c !== void 0 ? _c : map['*'])) {
                                        viewValue = (_d = map[value]) !== null && _d !== void 0 ? _d : (value === true && map['1']
                                            ...
                                            : value === false && map['0']
                                                ...
                                                : map['*']);
                                        label = viewValue;
                                        if (amisCore.isObject(viewValue)) {
                                        ...
                                        text = amisCore.removeHTMLTag(label);
                ...
                case 6:
                    ...
                    filteredColumns_1 = (e_5 = void 0, tslib.__values(filteredColumns)), filteredColumns_1_1 = filteredColumns_1.next();
                    _m.label = 7;
                case 7:
        ...
        return tslib.__generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    ...
                    filteredColumns_2 = tslib.__values(filteredColumns), filteredColumns_2_1 = filteredColumns_2.next();
                    _c.label = 2;
                case 2:
