...
var FlvSource = /** @class */ (function (_super) {
    ...
    FlvSource.prototype.render = function () {
        return (_J$X_("source", { src: this.props.src, type: this.props.type || 'video/x-flv' }));
    };
    return FlvSource;
...
var HlsSource = /** @class */ (function (_super) {
    ...
    HlsSource.prototype.render = function () {
        return (_J$X_("source", { src: this.props.src, type: this.props.type || 'application/x-mpegURL' }));
    };
    return HlsSource;
}(React__default["default"].Component));
var Video = /** @class */ (function (_super) {
    ...
    Video.prototype.renderFrames = function () {
        ...
        return (_J$X_("div", { className: cx("pos-rlt Video-frameList", framesClassName), ref: this.frameRef },
            amisCore.padArr(items, columnsCount).map(function (items, i) {
                ...
                return (_J$X_("div", { className: "pull-in-xs", key: i },
                    _J$X_("div", { className: cx("Hbox Video-frameItem") },
                        items.map(function (item, key) { return (_J$X_("div", { className: cx("Hbox-col Wrapper--xs Video-frame"), key: key, onClick: function () {
                                return _this.jumpToIndex(i * columnsCount + key);
                            } },
                            item.src ? (_J$X_("img", { className: "w-full", alt: "poster", src: item.src })) : null,
                            _J$X_("div", { className: cx("Video-frameLabel") }, item.time))); }),
                        /* 补充空白 */ restCount
                            ? blankArray.map(function (_, index) { return (_J$X_("div", { className: cx("Hbox-col Wrapper--xs"), key: "blank_".concat(index) })); })
                            : null)));
            }),
            jumpFrame ? (_J$X_("span", { ref: this.cursorRef, className: cx('Video-cursor') })) : null));
    };
    Video.prototype.renderPlayer = function () {
        ...
        if ((src && /\.flv(?:$|\?)/.test(src) && isLive) ||
            ...
            sourceNode = (_J$X_(FlvSource, { autoPlay: autoPlay, order: 999.0, isLive: isLive, src: src, setError: this.setError }));
        }
        else if ((src && /\.m3u8(?:$|\?)/.test(src)) ||
            videoType === 'application/x-mpegURL') {
            sourceNode = _J$X_(HlsSource, { autoPlay: autoPlay, order: 999.0, src: src });
        }
        else {
            sourceNode = _J$X_("source", { src: src });
        }
        return (_J$X_("div", { className: cx('Video-player', playerClassName) },
            _J$X_(videoReact.Player, { ref: this.playerRef, poster: amisCore.filter(poster, data, '| raw'), src: src, autoPlay: autoPlay, muted: muted, aspectRatio: aspectRatio, loop: loop },
                rates && rates.length ? (_J$X_(videoReact.ControlBar, null,
                    _J$X_(videoReact.PlaybackRateMenuButton, { rates: rates, order: 7.1 }))) : null,
                _J$X_(videoReact.BigPlayButton, { position: "center" }),
                sourceNode,
                _J$X_(videoReact.Shortcut, { disabled: true })),
            error ? _J$X_("div", { className: cx('Video-error') }, error) : null,
            highlight ? (_J$X_("p", { className: "m-t-xs ".concat(ns, "Text--danger") },
                "\u89C6\u9891\u65F6\u957F\u5C0F\u4E8E ",
                minVideoDuration,
                " \u79D2")) : null));
    };
    Video.prototype.renderPosterAndPlayer = function () {
        ...
        return (_J$X_("div", { className: "pull-in-xs" },
            _J$X_("div", { className: cx('Hbox') },
                _J$X_("div", { className: cx('Hbox-col') },
                    _J$X_("div", { className: cx('Wrapper Wrapper--xs') },
                        _J$X_("img", { onLoad: this.onImageLoaded, className: "w-full", alt: "poster", src: amisCore.filter(poster, data, '| raw') }),
                        _J$X_("p", { className: "m-t-xs" },
                            "\u5C01\u9762",
                            ' ',
                            _J$X_("span", { className: dimensionClassName },
                                posterInfo.width || '-',
                                " x ",
                                posterInfo.height || '-'),
                            dimensionClassName ? (_J$X_("span", null,
                                ' ',
                                "\u5C01\u9762\u5C3A\u5BF8\u5C0F\u4E8E",
                                ' ',
                                _J$X_("span", { className: cx('Text--danger') },
                                    minPosterDimension.width || '-',
                                    " x",
                                    ' ',
                                    minPosterDimension.height || '-'))) : null))),
                _J$X_("div", { className: cx('Hbox-col') },
                    _J$X_("div", { className: cx('Wrapper Wrapper--xs') }, this.renderPlayer())))));
    };
    Video.prototype.render = function () {
        ...
        return (_J$X_("div", { className: cx("Video", className), onClick: this.onClick, style: style },
            this.renderFrames(),
