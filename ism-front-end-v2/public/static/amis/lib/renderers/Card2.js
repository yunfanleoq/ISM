...
var Card2 = /** @class */ (function (_super) {
    ...
    Card2.prototype.renderCheckbox = function () {
        ...
        return (_J$X_(amisUi.Checkbox, { className: cx('Card2-checkbox', checkboxClassname), type: multiple ? 'checkbox' : 'radio', disabled: disabled, checked: selected, onChange: this.handleCheck }));
    };
    /**
     * 渲染内容区
     */
    Card2.prototype.renderBody = function () {
        ...
        return (_J$X_("div", { className: cx('Card2-body', bodyClassName), onClick: this.handleClick }, body ? render('body', body, rest) : null));
    };
    Card2.prototype.render = function () {
        ...
        return (_J$X_(Component, { className: cx('Card2', className, {
