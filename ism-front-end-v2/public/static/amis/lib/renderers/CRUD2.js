...
var CRUD2 = /** @class */ (function (_super) {
    ...
    CRUD2.prototype.handleSearch = function (data) {
        ...
        query =
            syncLocation && query
                ? amisCore.qsparse(amisCore.qsstringify(query, undefined, true))
                : query || {};
        /** 把布尔值反解出来 */
