...
var IconPickerControl = /** @class */ (function (_super) {
    ...
    IconPickerControl.prototype.renderFontIcons = function () {
        ...
        return (_J$X_(Downshift__default["default"], { isOpen: this.state.isOpen, inputValue: this.state.inputValue, onChange: this.handleChange, onOuterClick: this.handleBlur, onStateChange: this.handleStateChange, selectedItem: [value] }, function (_a) {
            ...
            var filteredOptions = inputValue && isOpen
                ...
                : options;
            return (_J$X_("div", { className: cx("IconPickerControl-input IconPickerControl-input--withAC", inputOnly ? className : '', {
                    'is-opened': isOpen
                }), onClick: _this.handleClick },
                _J$X_("div", { className: cx('IconPickerControl-valueWrap') },
                    placeholder && !value && !_this.state.inputValue ? (_J$X_("div", { className: cx('IconPickerControl-placeholder') }, placeholder)) : null,
                    !value || (inputValue && isOpen) ? null : (_J$X_("div", { className: cx('IconPickerControl-value') },
                        _J$X_("i", { className: cx(value) }),
                    ...
                    clearable && !disabled && value ? (_J$X_("a", { onClick: _this.handleClear, className: cx('IconPickerControl-clear') },
                        _J$X_(amisUi.Icon, { icon: "input-clear", className: "icon" }))) : null),
                isOpen ? (_J$X_("div", { className: cx('IconPickerControl-sugsPanel') },
                    vendors.length > 1 ? (_J$X_("div", { className: cx('IconPickerControl-tabs') }, vendors.map(function (vendor, index) { return (_J$X_("div", { className: cx('IconPickerControl-tab', {
                            active: _this.state.vendorIndex === index
                        }), onClick: function () { return _this.changeVendor(index); }, key: index }, vendor)); }))) : null,
                    filteredOptions.length ? (_J$X_("div", { className: cx('IconPickerControl-sugs', vendors.length > 1
                            ? 'IconPickerControl-multiVendor'
                            : 'IconPickerControl-singleVendor') }, filteredOptions.map(function (option, index) { return (_J$X_("div", tslib.__assign({}, getItemProps({
                        item: option.value,
                        className: cx("IconPickerControl-sugItem", {
                            'is-active': value === option.value
                        })
                    }), { key: index }),
                        _J$X_("i", { className: cx("".concat(option.value)), title: "".concat(option.value) }))); }))) : (_J$X_("div", { className: cx(vendors.length > 1
                            ? 'IconPickerControl-multiVendor'
    ...
    IconPickerControl.prototype.render = function () {
        ...
        return (_J$X_("div", { className: cx__default["default"](className, "".concat(ns, "IconPickerControl"), {
