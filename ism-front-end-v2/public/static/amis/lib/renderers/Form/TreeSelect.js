...
var TreeSelectControl = /** @class */ (function (_super) {
    ...
    function TreeSelectControl(props) {
        ...
        _this.handleInputChange = debounce__default["default"](_this.handleInputChange.bind(_this), 150, {
            trailing: true,
            leading: false
        });
        _this.handleInputKeyDown = _this.handleInputKeyDown.bind(_this);
        _this.loadRemote = debounce__default["default"](_this.loadRemote.bind(_this), 250, {
            trailing: true,
            leading: false
        });
        return _this;
    ...
    TreeSelectControl.prototype.resolveOptions = function () {
        ...
        return !amisCore.isEffectiveApi(autoComplete) && searchable && this.state.inputValue
    ...
    TreeSelectControl.prototype.handleFocus = function (e) {
        ...
        dispatchEvent('focus', amisCore.resolveEventData(this.props, { value: value, items: this.resolveOptions() }));
    };
    TreeSelectControl.prototype.handleBlur = function (e) {
        var _a = this.props, dispatchEvent = _a.dispatchEvent, value = _a.value;
        dispatchEvent('blur', amisCore.resolveEventData(this.props, { value: value, items: this.resolveOptions() }));
    };
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        if (!amisCore.isEffectiveApi(autoComplete, data) ||
                            (!input && amisCore.isEffectiveApi(source) && !this.sourceLoaded)) {
        ...
        if (Array.isArray(selectedOptions) && selectedOptions.length) {
            selectedOptions.forEach(function (option) {
                if (!find__default["default"](combinedOptions, function (item) { return item.value == option.value; })) {
                    combinedOptions.push(tslib.__assign({}, option));
                }
            });
        }
    ...
    TreeSelectControl.prototype.editItemFromAction = function (item, originValue) {
        ...
        onEdit && editItem && onEdit(tslib.__assign(tslib.__assign({}, item), { originValue: originValue }), editItem, true);
    };
    ...
    TreeSelectControl.prototype.render = function () {
        ...
        var resultValue = multiple
            ...
            : selectedOptions.length
                ...
                : '';
        return (_J$X_("div", { ref: this.container, className: cx("TreeSelectControl", className) },
            _J$X_(amisUi.ResultBox, { popOverContainer: popOverContainer || env.getModalContainer, maxTagCount: maxTagCount, overflowTagPopover: overflowTagPopover, disabled: disabled, ref: this.targetRef, placeholder: __(placeholder !== null && placeholder !== void 0 ? placeholder : 'placeholder.empty'), inputPlaceholder: '', className: cx("TreeSelect", {
                    ...
                    (searchable || amisCore.isEffectiveApi(autoComplete)) &&
                    (multiple || !resultValue), hasDropDownArrow: true, readOnly: mobileUI, mobileUI: mobileUI }, loading ? (_J$X_(amisUi.Spinner, { loadingConfig: loadingConfig, size: "sm" })) : undefined),
            !mobileUI && isOpened ? (_J$X_(amisCore.Overlay, { container: popOverContainer || (function () { return _this.container.current; }), target: function () { return _this.target; }, show: true },
                _J$X_(amisCore.PopOver, { classPrefix: ns, className: "".concat(ns, "TreeSelect-popover"), style: {
                        minWidth: this.target ? this.target.offsetWidth : undefined
                    }, onHide: this.close, overlay: true }, this.renderOuter()))) : null,
            mobileUI ? (_J$X_(amisUi.PopUp, { container: env.getModalContainer, className: cx("".concat(ns, "TreeSelect-popup")), isShow: isOpened, onHide: this.close, showConfirm: true, onConfirm: this.handleConfirm }, this.renderOuter())) : null));
    };
