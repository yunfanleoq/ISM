        ...
        return (_J$X_(React__default["default"].Fragment, null, stack.map(function (options, index) { return (_J$X_("div", { key: index, className: cx('NestedSelect-menu', menuClassName), style: _this.getMenuSelectMenuStyle() },
            ...
            options.map(function (option, idx) {
                ...
                return (_J$X_("div", { key: idx, className: cx('NestedSelect-option', {
                    ...
                    multiple ? (_J$X_(amisUi.Checkbox, { size: "sm", onChange: _this.handleCheck.bind(_this, option, index), trueValue: option[valueField], checked: selfChecked || (!cascade && selfChildrenChecked), partial: !selfChecked, disabled: nodeDisabled })) : null,
                    ...
                    option.children && option.children.length ? (_J$X_("div", { className: cx('NestedSelect-optionArrowRight', {
                            'is-disabled': nodeDisabled
                        }) },
