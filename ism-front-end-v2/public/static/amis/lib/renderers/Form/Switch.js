...
var SwitchControl = /** @class */ (function (_super) {
    ...
    SwitchControl.prototype.render = function () {
        var _a = this.props, size = _a.size, className = _a.className; _a.style; var ns = _a.classPrefix, cx = _a.classnames, value = _a.value, trueValue = _a.trueValue, falseValue = _a.falseValue; _a.onChange; var disabled = _a.disabled, loading = _a.loading, loadingConfig = _a.loadingConfig, testid = _a.testid;
        var _b = this.getResult(), on = _b.on, off = _b.off;
        return (_J$X_("div", { className: cx("SwitchControl", className) }, this.renderBody(_J$X_(amisUi.Switch, { classPrefix: ns, value: value, trueValue: trueValue, falseValue: falseValue, onText: on, offText: off, disabled: disabled, onChange: this.handleChange, size: size, loading: loading, loadingConfig: loadingConfig, testid: testid }))));
    };
