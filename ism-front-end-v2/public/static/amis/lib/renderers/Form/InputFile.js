...
var FileControl = /** @class */ (function (_super) {
            ...
            return tslib.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.dispatchEvent('success', tslib.__assign(tslib.__assign({}, file), { item: file, result: ret.data, value: value }))];
                    case 1:
                        dispatcher = _a.sent();
            ...
            return tslib.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.dispatchEvent('remove', tslib.__assign(tslib.__assign({}, removeFile), { item: removeFile }))];
                    case 1:
                        dispatcher = _a.sent();
                        if (dispatcher === null || dispatcher === void 0 ? void 0 : dispatcher.prevented) {
                            return [2 /*return*/];
        ...
        return tslib.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, env.fetcher(api, this.props.data, tslib.__assign(tslib.__assign({ method: 'post' }, options), { withCredentials: true, cancelExecutor: function (cancelExecutor) {
                                    // 记录取消器，取消的时候要调用
    ...
    FileControl.prototype.render = function () {
        ...
        return (_J$X_("div", { className: cx('FileControl', className) },
            templateUrl ? (_J$X_("a", { className: cx('FileControl-templateInfo'), onClick: this.downloadTpl.bind(this) },
                _J$X_(amisUi.Icon, { icon: "download", className: "icon" }),
                _J$X_("span", null, __('File.downloadTpl')))) : null,
            _J$X_(DropZone__default["default"], { disabled: disabled, key: "drop-zone", ref: this.dropzone, onDrop: this.handleDrop, onDropRejected: this.handleDropRejected, accept: accept === '*' ? '' : accept, multiple: multiple }, function (_a) {
                ...
                return (_J$X_("div", tslib.__assign({}, getRootProps({
                    ...
                    _J$X_("input", tslib.__assign({ disabled: disabled }, getInputProps(), { capture: capture }, amisCore.buildTestId(testid && "".concat(testid, "-input")))),
                    drag || isDragActive ? (_J$X_("div", { className: cx('FileControl-acceptTip'), onClick: _this.handleSelect },
                        _J$X_(amisUi.Icon, { icon: "cloud-upload", className: "icon" }),
                        _J$X_("span", null,
                            __('File.dragDrop'),
                            _J$X_("span", { className: cx('FileControl-acceptTip-click') }, __('File.clickUpload'))),
                        _J$X_("div", { className: cx('FileControl-acceptTip-help', 'TplField') }, documentLink ? (_J$X_("a", { href: documentLink, onClick: function (e) { return e.stopPropagation(); } }, documentation ? documentation : __('File.helpText'))) : null),
                        maxSize ? (_J$X_("div", { className: cx('FileControl-sizeTip') }, __('File.sizeLimit', {
                            maxSize: amisCore.prettyBytes(maxSize, 1024)
                        }))) : null)) : (_J$X_(React__default["default"].Fragment, null,
                        _J$X_(amisUi.Button, { level: "enhance", disabled: disabled, className: cx('FileControl-selectBtn', btnClassName, {
                                'is-disabled': multiple && !!maxLength && files.length >= maxLength
                            }), testid: testid, tooltip: multiple && maxLength && files.length >= maxLength
                                ? __('File.maxLength', { maxLength: maxLength })
                                : '', onClick: _this.handleSelect },
                            _J$X_(amisUi.Icon, { icon: "upload", className: "icon" }),
                            _J$X_("span", null, !multiple && files.length
                                ? __('File.repick')
                                : multiple && files.length
                                    ? __('File.continueAdd')
                                    : amisCore.filter(btnLabel, data) || __('File.upload')))))));
            }),
            description
                ...
                : null,
            maxSize && !drag ? (_J$X_("div", { className: cx('FileControl-sizeTip') }, __('File.sizeLimit', { maxSize: amisCore.prettyBytes(maxSize, 1024) }))) : null,
            Array.isArray(files) ? (_J$X_("ul", { className: cx('FileControl-list') }, files.map(function (file, index) {
                var filename = file[nameField] ||
                    file.filename ||
                    file.name;
                return (_J$X_("li", { key: file.id },
                    _J$X_(amisUi.TooltipWrapper, { placement: "top", container: container || (env === null || env === void 0 ? void 0 : env.getModalContainer), tooltipClassName: cx('FileControl-list-tooltip', (file.state === 'invalid' || file.state === 'error') &&
                            ...
                            ? file.error ||
                                (maxSize && file.size > maxSize
                                    ...
                                    : '')
                            : filename },
                        _J$X_("div", { className: cx('FileControl-itemInfo', {
                                'is-invalid': file.state === 'invalid' || file.state === 'error'
                            }) },
                            _J$X_("span", { className: cx('FileControl-itemInfoIcon') },
                                _J$X_(amisUi.Icon, { icon: "file", className: "icon" })),
                            file[urlField] ||
                                file[valueField] ||
                                downloadUrl ? (_J$X_("a", { className: cx('FileControl-itemInfoText'), target: "_blank", rel: "noopener", href: "#", onClick: _this.handleClickFile.bind(_this, file) }, filename)) : (_J$X_("span", { className: cx('FileControl-itemInfoText') }, filename)),
                            !disabled ? (_J$X_("a", { "data-tooltip": __('Select.clear'), "data-position": "left", className: cx('FileControl-clear'), onClick: function () { return _this.removeFile(file, index); } },
                                _J$X_(amisUi.Icon, { icon: "close", className: "icon" }))) : null)),
                    file.state === 'uploading' ? (_J$X_("div", { className: cx('FileControl-progressInfo') },
                        _J$X_("div", { className: cx('FileControl-progress') },
                            _J$X_("span", { style: { width: "".concat((file.progress || 0) * 100, "%") } })),
                        _J$X_("span", null,
                            Math.round((file.progress || 0) * 100),
                            "%"))) : null));
            }))) : null,
            failed ? (_J$X_("div", { className: cx('FileControl-sum') },
                __('File.result', {
                    uploaded: uploaded,
                    failed: failed
                }),
                _J$X_("a", { onClick: this.retry }, __('File.retry')),
                __('File.failed'))) : null,
            !autoUpload && !hideUploadButton && files.length ? (_J$X_(amisUi.Button, { level: "default", disabled: !hasPending, className: cx('FileControl-uploadBtn', btnUploadClassName), onClick: this.toggleUpload }, __(uploading ? 'File.pause' : 'File.start'))) : null));
    };
