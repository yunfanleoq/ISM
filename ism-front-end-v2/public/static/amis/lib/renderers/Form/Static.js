...
var StaticControl = /** @class */ (function (_super) {
    ...
    StaticControl.prototype.render = function () {
        var _a;
        var _b = this.props, className = _b.className; _b.style; var value = _b.value, label = _b.label, type = _b.type, render = _b.render; _b.children; var data = _b.data, cx = _b.classnames, name = _b.name, disabled = _b.disabled, $schema = _b.$schema, defaultValue = _b.defaultValue, borderMode = _b.borderMode, rest = tslib.__rest(_b, ["className", "style", "value", "label", "type", "render", "children", "data", "classnames", "name", "disabled", "$schema", "defaultValue", "borderMode"]);
        var subType = /^static/.test(type)
            ? type.substring(7) || (rest.tpl ? 'tpl' : 'plain')
            : type;
        var field = tslib.__assign(tslib.__assign({ label: label, name: name }, $schema), { style: $schema.innerStyle, type: subType });
        return (_J$X_("div", { className: cx('Form-static', (_a = {},
                _a["Form-static--border".concat(amisCore.ucFirst(borderMode))] = borderMode,
                _a)) },
            _J$X_(StaticFieldRenderer, tslib.__assign({}, tslib.__assign(tslib.__assign({}, rest), { name: name, render: render, field: field, value: value === defaultValue ? undefined : value, className: className, onQuickChange: this.handleQuickChange, data: data, disabled: disabled, classnames: cx })))));
    };
...
var StaticFieldRenderer = /** @class */ (function (_super) {
    ...
    StaticFieldRenderer.prototype.render = function () {
        ...
        return (_J$X_(Component, { className: className, tabIndex: tabIndex, onKeyUp: onKeyUp }, body));
    };
