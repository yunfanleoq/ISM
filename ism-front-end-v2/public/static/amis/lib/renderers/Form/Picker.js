...
var PickerControl = /** @class */ (function (_super) {
    ...
    PickerControl.prototype.renderTag = function (item, index) {
        ...
        return (_J$X_("div", { key: index, className: cx("".concat(ns, "Picker-value"), amisCore.setThemeClassName(tslib.__assign(tslib.__assign({}, this.props), { name: 'pickValueWrapClassName', id: id, themeCss: themeCss || css })), {
                'is-disabled': disabled
            }) },
            _J$X_("span", { className: cx("".concat(ns, "Picker-valueIcon"), amisCore.setThemeClassName(tslib.__assign(tslib.__assign({}, this.props), { name: 'pickValueIconClassName', id: id, themeCss: themeCss || css }))), onClick: function (e) {
                    e.stopPropagation();
                    _this.removeItem(index);
                } }, "\u00D7"),
            _J$X_("span", { className: cx("".concat(ns, "Picker-valueLabel"), amisCore.setThemeClassName(tslib.__assign(tslib.__assign({}, this.props), { name: 'pickFontClassName', id: id, themeCss: themeCss || css }))), onClick: function (e) {
                    e.stopPropagation();
            ...
            if (enableOverflow && index === maxTagCount) {
                return (_J$X_(amisUi.TooltipWrapper, { key: index, container: popOverContainer, tooltip: tslib.__assign(tslib.__assign({ tooltipClassName: cx__default["default"]('Picker-overflow', overflowTagPopover === null || overflowTagPopover === void 0 ? void 0 : overflowTagPopover.tooltipClassName), title: __('已选项') }, omit__default["default"](overflowTagPopover, [
                    ...
                    _J$X_("div", { key: index, className: cx__default["default"]("".concat(ns, "Picker-value"), {
                        ...
                        _J$X_("span", { className: "".concat(ns, "Picker-valueLabel ").concat(amisCore.setThemeClassName(tslib.__assign(tslib.__assign({}, _this.props), { name: 'pickFontClassName', id: id, themeCss: themeCss || css }))) }, item.label))));
            }
    ...
    PickerControl.prototype.renderBody = function (_a) {
        ...
        return render('modal-body', this.state.schema, tslib.__assign({ value: selectedOptions, valueField: valueField, primaryField: valueField, options: source ? [] : options, multiple: multiple, strictMode: strictMode, onSelect: embed ? this.handleSelect : undefined, ref: this.crudRef, popOverContainer: popOverContainer }, (embed ||
    ...
    PickerControl.prototype.render = function () {
        ...
        return (_J$X_("div", { className: cx("PickerControl", { 'is-mobile': mobileUI }, className) },
            embed ? (_J$X_("div", { className: cx('Picker') }, this.renderBody({ popOverContainer: popOverContainer }))) : (_J$X_("div", { className: cx("Picker", {
                ...
                _J$X_("div", { onClick: this.handleClick, className: cx('Picker-input', amisCore.setThemeClassName(tslib.__assign(tslib.__assign({}, this.props), { name: 'pickControlClassName', id: id, themeCss: themeCss || css })), amisCore.setThemeClassName(tslib.__assign(tslib.__assign({}, this.props), { name: 'pickControlDisabledClassName', id: id, themeCss: themeCss || css }))) },
                    ...
                    _J$X_("span", { onClick: this.open, className: cx('Picker-btn') },
                        _J$X_(amisUi.Icon, { icon: "window-restore", className: cx('icon', amisCore.setThemeClassName(tslib.__assign(tslib.__assign({}, this.props), { name: 'pickIconClassName', id: id, themeCss: themeCss || css }))), iconContent: "Picker-icon" }))),
                render('modal', {
            ...
            _J$X_(amisCore.CustomStyle, tslib.__assign({}, this.props, { config: {
                    ...
                    classNames: [
                        ...
                        },
                        {
                            ...
                            weights: {
                                default: {
                                    pre: "".concat(ns, "Picker.is-disabled> .").concat(amisCore.setThemeClassName(tslib.__assign(tslib.__assign({}, this.props), { name: 'pickControlDisabledClassName', id: id, themeCss: themeCss || css })), ", ")
                                }
                            }
                        },
                        {
    ...
    tslib.__decorate([
        ...
        tslib.__metadata("design:returntype", void 0)
    ], PickerControl.prototype, "handleSelect", null);
    tslib.__decorate([
        amisCore.autobind,
        tslib.__metadata("design:type", Function),
        tslib.__metadata("design:paramtypes", [Object]),
