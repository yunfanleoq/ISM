...
import { resolveVariableAndFilter, createObject, isMobile, isVisible, isDisabled, filterClassNameObject, getTestId, RootClose, noop, Overlay, PopOver, buildTestId, filter, Renderer } from 'amis-core';
...
var DropDownButton = /** @class */ (function (_super) {
    ...
    DropDownButton.prototype.close = function (e) {
        var _this = this;
        var _a, _b;
        var _c = this.props, _buttons = _c.buttons, data = _c.data;
        ...
        if (!((_b = (_a = e === null || e === void 0 ? void 0 : e.target) === null || _a === void 0 ? void 0 : _a.getAttribute) === null || _b === void 0 ? void 0 : _b.call(_a, 'download'))) {
    ...
    DropDownButton.prototype.renderButton = function (button, index) {
        var _a;
        var _this = this;
        var _b = this.props, render = _b.render, cx = _b.classnames, data = _b.data, testid = _b.testid, ignoreConfirm = _b.ignoreConfirm;
        ...
        if (typeof button !== 'string' && !isVisible(button, data)) {
            ...
            return (React.createElement("li", { key: index, className: cx('DropDown-button', (_a = {},
                    ...
                    : button.level
                        ...
                        : '', filterClassNameObject(button.className, data)) }, render("button/".concat(index), __assign(__assign({ type: 'button', testid: testid &&
                    "".concat(getTestId(testid, data), "-").concat(button.testid || index) }, button), { className: '' }), {
                isMenuItem: true,
