...
import { guid, getTestId, setVariable, setThemeClassName, filter, CustomStyle, autobind, ValidateError, filterTarget, isVisible, createObject, ScopedContext, Renderer, ModalStore, isObjectShallowModified } from 'amis-core';
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 8:
                        ...
                        return [3 /*break*/, 13];
                    case 9:
                        if (!(!action.from && this.tryChildrenToHandle(action, data))) return [3 /*break*/, 10];
                        return [3 /*break*/, 13];
                    case 10:
