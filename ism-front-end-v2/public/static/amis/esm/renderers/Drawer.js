...
import { guid, getTestId, setThemeClassName, CustomStyle, autobind, ValidateError, filter, filterTarget, isVisible, createObject, ScopedContext, Renderer, ModalStore, isObjectShallowModified } from 'amis-core';
...
var Drawer = /** @class */ (function (_super) {
    ...
    Drawer.prototype.buildActions = function () {
        var _a = this.props, actions = _a.actions, confirm = _a.confirm, testid = _a.testid, __ = _a.translate;
        ...
        ret.push({
            type: 'button',
            testid: getTestId(testid && "".concat(testid, "-cancel")),
            actionType: 'close',
            label: __('cancel')
        });
        if (confirm) {
            ret.push({
                type: 'button',
                actionType: 'confirm',
                testid: getTestId(testid && "".concat(testid, "-confirm")),
                label: __('confirm'),
                primary: true
            });
        }
    ...
    Drawer.prototype.renderFooter = function () {
        ...
        return (React.createElement("div", { className: cx('Drawer-footer', footerClassName, setThemeClassName(__assign(__assign({}, this.props), { name: 'drawerFooterClassName', id: id, themeCss: themeCss }))) },
    ...
    Drawer.prototype.render = function () {
        ...
        return (React.createElement(Container, __assign({}, rest, { resizable: resizable, classPrefix: ns, className: className, style: style, drawerClassName: setThemeClassName(__assign(__assign({}, this.props), { name: 'drawerClassName', id: id, themeCss: themeCss })), drawerMaskClassName: setThemeClassName(__assign(__assign({}, this.props), { name: 'drawerMaskClassName', id: id, themeCss: themeCss })), size: size, onHide: this.handleSelfClose, disabled: store.loading, show: show, showCloseButton: showCloseButton, width: width, height: height, position: position, overlay: overlay, onEntered: this.handleEntered, onExited: this.handleExited, closeOnEsc: closeOnEsc, closeOnOutside: !store.drawerOpen && !store.dialogOpen && closeOnOutside, container: drawerContainer ? drawerContainer : env === null || env === void 0 ? void 0 : env.getModalContainer }),
            React.createElement("div", { className: cx('Drawer-header', headerClassName, setThemeClassName(__assign(__assign({}, this.props), { name: 'drawerHeaderClassName', id: id, themeCss: themeCss }))) },
                title ? (React.createElement("div", { className: cx('Drawer-title', setThemeClassName(__assign(__assign({}, this.props), { name: 'drawerTitleClassName', id: id, themeCss: themeCss }))) }, render('title', title, {
                    data: store.formData,
                ...
                header
                    ...
                    : null),
            !store.entered ? (React.createElement("div", { className: cx('Drawer-body', bodyClassName, setThemeClassName(__assign(__assign({}, this.props), { name: 'drawerBodyClassName', id: id, themeCss: themeCss }))) },
                React.createElement(Spinner, { overlay: true, show: true, size: "lg", loadingConfig: loadingConfig }))) : body ? (
            // dialog-body 用于在 editor 中定位元素
            React.createElement("div", { className: cx('Drawer-body', bodyClassName, setThemeClassName(__assign(__assign({}, this.props), { name: 'drawerBodyClassName', id: id, themeCss: themeCss }))), role: "dialog-body" },
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 6:
                        ...
                        return [3 /*break*/, 11];
                    case 7:
                        if (!(!action.from && this.tryChildrenToHandle(action, data))) return [3 /*break*/, 8];
                        return [3 /*break*/, 11];
                    case 8:
