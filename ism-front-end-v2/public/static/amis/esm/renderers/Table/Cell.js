...
function Cell(_a) {
    ...
    if (column.type === '__checkme') {
        return (React.createElement("td", { style: style, className: cx(column.pristine.className, stickyClassName) },
        ...
        return (React.createElement("td", { style: style, className: cx(column.pristine.className, stickyClassName) }, item.expandable ? (React.createElement("a", { className: cx('Table-expandBtn', item.expanded ? 'is-active' : ''), 
            // data-tooltip="展开/收起"
            // data-position="top"
