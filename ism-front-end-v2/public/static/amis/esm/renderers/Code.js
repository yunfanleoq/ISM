...
import { __extends, __awaiter, __generator, __values, __decorate } from 'tslib';
...
var Code = /** @class */ (function (_super) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        sourceCode = getPropValue(this.props);
    ...
    Code.prototype.registerAndGetTheme = function () {
        ...
        if (this.customLang &&
            ...
            var colors = ((_b = this.customLang) === null || _b === void 0 ? void 0 : _b.colors) && isPlainObject((_c = this.customLang) === null || _c === void 0 ? void 0 : _c.colors)
            ...
            var rules = [];
            try {
                for (var _e = __values(this.customLang.tokens), _f = _e.next(); !_f.done; _f = _e.next()) {
                    var token = _f.value;
    ...
    Code.prototype.render = function () {
        ...
        return (React.createElement(Component, { ref: this.codeRef, className: cx('Code', {
