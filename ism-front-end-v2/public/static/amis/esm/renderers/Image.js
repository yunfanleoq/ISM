...
import { __extends, __rest, __decorate, __metadata, __assign, __awaiter, __generator } from 'tslib';
...
var ImageField = /** @class */ (function (_super) {
    ...
    ImageField.prototype.handleEnlarge = function (_a) {
        ...
        onImageEnlarge &&
            onImageEnlarge({
                ...
                imageGallaryClassName: "".concat(imageGallaryClassName, " ").concat(setThemeClassName(__assign(__assign({}, this.props), { name: 'imageGallaryClassName', id: id, themeCss: themeCss })), " ").concat(setThemeClassName(__assign(__assign({}, this.props), { name: 'galleryControlClassName', id: id, themeCss: themeCss })))
            }, this.props);
    };
    ...
    ImageField.prototype.render = function () {
        ...
        return (React.createElement("div", { className: cx('ImageField', imageMode === 'original'
                ? 'ImageField--original'
                : 'ImageField--thumb', className, setThemeClassName(__assign(__assign({}, this.props), { name: 'wrapperCustomStyle', id: id, themeCss: wrapperCustomStyle }))), style: __assign(__assign({}, style), { transform: "scale(".concat(this.state.scale, ")") }), onClick: this.handleClick, onMouseEnter: this.handleMouseEnter, onMouseLeave: this.handleMouseLeave },
            value || (!value && !placeholder) ? (React.createElement(ThemedImageThumb, { className: innerClassName, imageClassName: imageClassName, thumbClassName: thumbClassName, height: height, width: width, src: value ? value : defaultValue, href: finnalHref, title: filter(title, data), caption: filter(imageCaption, data), thumbMode: thumbMode, thumbRatio: thumbRatio, originalSrc: (_a = filter(originalSrc, data, '| raw')) !== null && _a !== void 0 ? _a : value, enlargeAble: enlargeAble && value && value !== defaultValue, onEnlarge: this.handleEnlarge, imageMode: imageMode, imageControlClassName: setThemeClassName(__assign(__assign({}, this.props), { name: 'imageControlClassName', id: id, themeCss: themeCss })), titleControlClassName: setThemeClassName(__assign(__assign({}, this.props), { name: 'titleControlClassName', id: id, themeCss: themeCss })), desControlClassName: setThemeClassName(__assign(__assign({}, this.props), { name: 'desControlClassName', id: id, themeCss: themeCss })), iconControlClassName: setThemeClassName(__assign(__assign({}, this.props), { name: 'iconControlClassName', id: id, themeCss: themeCss })) })) : (React.createElement("span", { className: "text-muted" }, placeholder)),
