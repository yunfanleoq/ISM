...
import { createObject, hasAbility, columnsSplit, flattenTreeWithLeafNodes, autobind, OptionsControl } from 'amis-core';
...
var CheckboxesControl = /** @class */ (function (_super) {
    ...
    CheckboxesControl.prototype.renderItem = function (option, index) {
        ...
        return (React.createElement(Checkbox, { className: itemClassName, key: index, onChange: function () { return onToggle(option); }, checked: !!~selectedOptions.indexOf(option), disabled: disabled || option.disabled, inline: inline, labelClassName: optionLabelClassName || labelClassName, description: option.description, optionType: optionType },
            menuTpl
