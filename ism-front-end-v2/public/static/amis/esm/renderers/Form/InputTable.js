...
import { SimpleMap, isPureVariable, resolveVariableAndFilter, getVariable, dataMapping, isEffectiveApi, filterDate, setVariable, isExpression, resolveEventData, createObject, isObject, getRendererByName, getTree, spliceTree, mapTree, autobind, evalExpressionWithConditionBuilder, FormItem, filter } from 'amis-core';
...
var FormTable = /** @class */ (function (_super) {
    ...
    FormTable.prototype.componentDidUpdate = function (prevProps, prevState) {
        ...
        if (prevProps.disabled !== props.disabled ||
            ...
            toUpdate = __assign(__assign({}, toUpdate), { items: items, editIndex: -1, columns: this.buildColumns(props) });
        }
        if (props.columns !== prevProps.columns) {
            toUpdate = __assign(__assign({}, toUpdate), { columns: this.buildColumns(props) });
        }
        if (props.value !== prevProps.value) {
            toUpdate = __assign(__assign({}, toUpdate), { items: Array.isArray(props.value) ? props.value.concat() : [], editIndex: -1 });
        }
                    ...
                    case 6:
                        if (actionType === 'remove' || actionType === 'delete') {
                            ...
                            toRemove.forEach(function (toRemove) {
                                var idx = findIndex(items_2, function (item) { return item[valueField] == toRemove[valueField]; });
                                if (~idx) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                if (needConfirm === false) {
                    ...
                    items.splice(index + 1, 0, __assign(__assign({}, items[index]), { __isPlaceholder: true }));
                }
    ...
    FormTable.prototype.addItem = function (index, isDispatch) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                ...
                index = Math.min(index + 1, items.length - 1);
                this.setState(__assign({ items: items }, (needConfirm === false
                    ? {}
                    : {
                        editIndex: index,
                        isCreateMode: true,
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        items = this.state.items;
                        return [4 /*yield*/, dispatchEvent(eventName, resolveEventData(this.props, __assign({ value: __spreadArray([], __read(items), false) }, eventData)))];
                    case 1:
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 1:
                        ...
                        items = this.state.items.concat();
                        item = __assign({}, items[this.state.editIndex]);
                    ...
                    case 3:
                        ...
                        return [3 /*break*/, 6];
                    case 4:
                        if (!isEffectiveApi(updateApi, createObject(data, item))) return [3 /*break*/, 6];
                    ...
                    case 6:
                        if (remote && !remote.ok) {
                            ...
                            item = merge({}, (isNew ? addApi : updateApi).replaceData ? {} : item, remote.data);
                        }
    ...
    FormTable.prototype.cancelEdit = function () {
        ...
        var item = __assign({}, items[this.state.editIndex]);
        ...
        if (isNew) {
            ...
            if (lastModifiedRow &&
                ...
                items.splice(this.state.editIndex, 1, __assign(__assign({}, item), lastModifiedRow.data));
            }
        }
        this.setState({
            editIndex: -1,
    ...
    FormTable.prototype.buildColumns = function (props, isCreateMode, editRowIndex) {
            ...
            btns.push({
                children: function (_a) {
                    ...
                    return (~_this.state.editIndex && needConfirm !== false) ||
                        maxLength <= _this.state.items.length ? null : (React.createElement(Button, { classPrefix: ns, size: "sm", key: key, level: "link", tooltip: __('Table.addRow'), tooltipContainer: props.popOverContainer || env.getModalContainer, disabled: disabled, onClick: _this.addItem.bind(_this, rowIndex + offset, undefined) },
        ...
        if (!isStatic && props.copyable && props.showCopyBtn !== false) {
            btns.push({
                children: function (_a) {
                    var key = _a.key, rowIndex = _a.rowIndex, offset = _a.offset;
                    return ~_this.state.editIndex && needConfirm !== false ? null : (React.createElement(Button, { classPrefix: ns, size: "sm", key: key, level: "link", tooltip: __('Table.copyRow'), tooltipContainer: props.popOverContainer || env.getModalContainer, disabled: disabled, onClick: _this.copyItem.bind(_this, rowIndex + offset, undefined) },
        ...
        if (props.needConfirm === false) {
            columns = columns.map(function (column) {
                ...
                return quickEdit === false
                    ...
                    : __assign(__assign({}, column), (column.type === 'operation'
                        ? {}
                        : {
                            quickEdit: __assign(__assign(__assign({}, _this.columnToQuickEdit(column)), quickEdit), { saveImmediately: true, mode: 'inline', disabled: disabled, static: isStatic })
                        }));
            });
        }
            ...
            columns = columns.map(function (column, index) {
                ...
                return __assign(__assign({}, (quickEdit === false
                    ? omit(column, ['quickEdit'])
                    : __assign(__assign({}, column), { quickEdit: __assign(__assign(__assign({}, _this.columnToQuickEdit(column)), quickEdit), { isQuickEditFormMode: !!(render === null || render === void 0 ? void 0 : render.isFormItem), saveImmediately: true, mode: 'inline', disabled: disabled }) }))), (enableStaticTransform && props.needConfirm !== false
            ...
            !isStatic &&
                ...
                btns.push({
                    children: function (_a) {
                        ...
                        return ~_this.state.editIndex || (data && data.__isPlaceholder) ? null : (React.createElement(Button, { classPrefix: ns, size: "sm", key: key, level: "link", tooltip: __('Table.editRow'), tooltipContainer: props.popOverContainer || env.getModalContainer, disabled: disabled, onClick: function () { return _this.editItem(rowIndex + offset); } },
            ...
            !isStatic &&
                btns.push({
                    children: function (_a) {
                        var key = _a.key, rowIndex = _a.rowIndex, offset = _a.offset;
                        return _this.state.editIndex === rowIndex + offset ? (React.createElement(Button, { classPrefix: ns, size: "sm", key: key, level: "link", tooltip: __('save'), tooltipContainer: props.popOverContainer || env.getModalContainer, onClick: _this.confirmEdit },
            ...
            !isStatic &&
                btns.push({
                    children: function (_a) {
                        var key = _a.key, rowIndex = _a.rowIndex, offset = _a.offset;
                        return _this.state.editIndex === rowIndex + offset ? (React.createElement(Button, { classPrefix: ns, size: "sm", key: key, level: "link", tooltip: __('cancel'), tooltipContainer: props.popOverContainer || env.getModalContainer, onClick: _this.cancelEdit },
            ...
            columns = columns.map(function (column) {
                ...
                if (!!(render === null || render === void 0 ? void 0 : render.isFormItem)) {
                    return __assign(__assign({}, column), { quickEdit: __assign(__assign({}, column), { isFormMode: true }) });
                }
                return column;
            });
        }
            ...
            btns.push({
                children: function (_a) {
                    ...
                    return ((~_this.state.editIndex || (data && data.__isPlaceholder)) &&
                        needConfirm !== false) ||
                        minLength >= _this.state.items.length ? null : (React.createElement(Button, { classPrefix: ns, size: "sm", key: key, level: "link", tooltip: __('Table.deleteRow'), tooltipContainer: props.popOverContainer || env.getModalContainer, disabled: disabled, onClick: _this.removeItem.bind(_this, rowIndex + offset) },
        ...
        if (showIndex) {
            columns.unshift({
                ...
                children: function (props) {
                    return React.createElement("td", null, props.offset + props.data.index + 1);
                }
            });
        }
        return columns;
    ...
    FormTable.prototype.handleTableSave = function (rows, diff, rowIndexes) {
        ...
        this.setState(function (state, props) {
            ...
            if (~editIndex) {
                ...
                Object.assign(newState, __assign({ items: items_3 }, ((lastModifiedRow === null || lastModifiedRow === void 0 ? void 0 : lastModifiedRow.index) === editIndex
                    ? {}
                    : {
            ...
            if (Array.isArray(rows)) {
                rowIndexes.forEach(function (rowIndex, index) {
                    ...
                    var data = merge({}, origin, diff[index]);
                ...
                var origin_2 = getTree(items, indexes);
                var comboNames_1 = [];
                ...
                var data = mergeWith({}, origin_2, diff, function (objValue, srcValue, key, object, source, stack) {
    ...
    FormTable.prototype.handleRadioChange = function (cxt, _a) {
        ...
        var path = row.path;
        var items = mapTree(this.state.items, function (item, index, level, paths, indexes) {
            var _a;
    ...
    FormTable.prototype.render = function () {
        ...
        return (React.createElement("div", { className: cx('InputTable', className) },
            ...
            (!isStatic &&
                ...
                showPager ? (React.createElement("div", { className: cx('InputTable-toolbar', toolbarClassName) },
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        items = __spreadArray([], __read(this.state.items), false);
                        i = 0;
                        _a.label = 2;
                    case 2:
                ...
                switch (_g.label) {
                    ...
                    case 3:
                        toAdd_2 = (Array.isArray(toAdd_2) ? toAdd_2 : [toAdd_2]).filter(function (a) {
                            return !valueField ||
                                !find(items_5, function (item) { return item[valueField] == a[valueField]; });
                        });
                        index = args.index;
                        ...
                        if (typeof index === 'number') {
                            items_5.splice.apply(items_5, __spreadArray([index, 0], __read(toAdd_2), false));
                        }
                        else {
                            // 没有指定默认插入在最后
                            items_5.push.apply(items_5, __spreadArray([], __read(toAdd_2), false));
                        }
                        this.setState({
                            items: items_5
                        }, function () {
                    ...
                    case 6:
                        ...
                        items_6 = __spreadArray([], __read(this.state.items), false);
                        rawItems_1 = [];
                        deletedItems = [];
                    ...
                    case 8:
                        ...
                        return [4 /*yield*/, evalExpressionWithConditionBuilder(args.condition, __assign(__assign({}, items_6[i]), { rowIndex: i }))];
                    case 9:
                        flag = _g.sent();
                        if (!flag) {
                    ...
                    case 10:
                        ...
                        return [3 /*break*/, 8];
                    case 11:
                        if (!isEffectiveApi(deleteApi, createObject(ctx, { deletedItems: deletedItems }))) return [3 /*break*/, 13];
                        return [4 /*yield*/, env.fetcher(deleteApi, createObject(ctx, { deletedItems: deletedItems }))];
                    case 12:
                        payload = _g.sent();
                        if (payload && !payload.ok) {
                            !(deleteApi === null || deleteApi === void 0 ? void 0 : deleteApi.silent) &&
                    ...
                    case 14:
                        ...
                        _g.label = 15;
                    case 15: return [2 /*return*/, _super.prototype.doAction.apply(this, __spreadArray([action, ctx], __read(rest), false))];
                }
            });
        });
    };
