...
import { findTreeIndex, hasAbility, findTree, resolveEventData, createObject, isEffectiveApi, isPureVariable, resolveVariableAndFilter, toNumber, autobind, OptionsControl } from 'amis-core';
...
var TreeControl = /** @class */ (function (_super) {
    ...
    TreeControl.prototype.render = function () {
        ...
        return (React.createElement("div", { className: cx("".concat(ns, "TreeControl"), className, treeContainerClassName, {
