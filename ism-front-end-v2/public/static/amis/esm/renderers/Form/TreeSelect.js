...
import { isEffectiveApi, resolveEventData, normalizeOptions, findTreeIndex, hasAbility, findTree, createObject, getTreeAncestors, toNumber, Overlay, PopOver, autobind, OptionsControl } from 'amis-core';
...
var TreeSelectControl = /** @class */ (function (_super) {
    ...
    TreeSelectControl.prototype.handleFocus = function (e) {
        ...
        dispatchEvent('focus', resolveEventData(this.props, { value: value, items: this.resolveOptions() }));
    };
    TreeSelectControl.prototype.handleBlur = function (e) {
        var _a = this.props, dispatchEvent = _a.dispatchEvent, value = _a.value;
        dispatchEvent('blur', resolveEventData(this.props, { value: value, items: this.resolveOptions() }));
    };
