...
var Grid2D = /** @class */ (function (_super) {
    ...
    Grid2D.prototype.renderGrid = function (grid, key, length) {
        ...
        return (React.createElement("div", { key: key, style: style, className: grid.gridClassName }, itemRender
    ...
    Grid2D.prototype.render = function () {
        ...
        var curStyle = __assign(__assign({}, style), { display: 'grid', columnGap: gap, rowGap: typeof gapRow === 'undefined' ? gap : gapRow, width: width, gridTemplateColumns: templateColumns.join(' '), gridTemplateRows: templateRows.join(' ') });
        return React.createElement("div", { style: curStyle }, this.renderGrids());
    };
...
/** @class */ ((function (_super) {
    __extends(Grid2DRenderer, _super);
    function Grid2DRenderer() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    Grid2DRenderer = __decorate([
        Renderer({
            type: 'grid-2d'
        })
    ], Grid2DRenderer);
