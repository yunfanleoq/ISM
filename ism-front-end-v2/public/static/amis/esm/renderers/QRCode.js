    ...
    QRCode.prototype.doAction = function (action, args, throwErrors) {
        ...
        if (actionType === 'saveAs') {
            ...
            if ((_a = this.ref) === null || _a === void 0 ? void 0 : _a.current) {
                ...
                if (svgElement) {
                    var contentWithSvg = "<svg xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\" version=\"1.1\" height=\"".concat(codeSize, "\" width=\"").concat(codeSize, "\" viewBox=\"0 0 37 37\">\n         ").concat(svgElement.innerHTML, "\n         </svg>");
