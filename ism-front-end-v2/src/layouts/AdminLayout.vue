<template>
  <a-layout :class="['admin-layout', 'beauty-scroll']">
    ...
    <a-layout class="admin-layout-main beauty-scroll">
      ...
      <breadcrumb-header ref="BreadcrumbHeader"  :breadcrumb="breadcrumb" ></breadcrumb-header>
...
import BreadcrumbHeader from '@/components/page/header/BreadcrumbHeader'
// const minHeight = window.innerHeight - 64 - 122
import {getI18nKey} from '@/utils/routerUtil'
export default {
  name: 'AdminLayout',
  components: {Setting, SideMenu, Drawer, PageFooter, AdminHeader,BreadcrumbHeader},
  data () {
    return {
      minHeight: window.innerHeight - 31 - 122,
      collapsed: false,
      showSetting: false,
      drawerOpen: false
    }
