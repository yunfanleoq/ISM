...
export default {
  ...
  methods: {
    ...
    save() {
      this.RegisterForm.validateFields((err) => {
        if (!err) {
          ...
          let _t = this
          CJT188ModelNodeIDEdit(params).then(function (res){
    ...
    NodeIdList(){
      ...
      CJT188ModelNodeIDList(params).then(function (res){
    ...
    AddNodeId(){
      this.RegisterForm.validateFields((err) => {
        if (!err) {
          ...
          this.RegisterVisible = false;
          let _t = this
          CJT188ModelNodeIDAdd(params).then(function (res){
            _t.messageShowLoad = false
            if(res.data.code==2002)
            {
              _t.NodeIdList()
    ...
    deleteRecord(uuid,muid) {
      ...
      CJT188ModelNodeIDDel(params).then(function (res) {
