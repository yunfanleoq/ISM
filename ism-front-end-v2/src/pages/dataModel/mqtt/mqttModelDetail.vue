  ...
  <a-card  >
    <a-spin style="padding: 1px;"  :spinning="messageShowLoad" tip="Loading...">
      <a-form @submit="onSubmit" :form="form">
        ...
        >
            <span slot="label">
            {{ $t('dataModel.Mqtt.setContent') }}&nbsp;
            <a-tooltip :title="$t('dataModel.Mqtt.setContentSm')">
  ...
  methods: {
    ...
    getSingleModelDetail(){
      ...
      getSnmpModelDetail(params).then(function (res){
        ...
        _t.isCharge = false
       _t.CodeContent= res.data.data.MqttSetDataFormat
    ...
    onSubmit (e) {
      ...
      this.form.validateFields((err) => {
        if (!err) {
          ...
          {
            _t.$message.error(_t.$t('dataModel.Mqtt.setContentLength'), 3)
            return
          }
          this.messageShowLoad = true
          const params = {
            ...
            data: {
              ...
              MqttSetDataFormat:this.CodeContent,
              type:20
            }
          };
          MqttModelEdit(params).then(function (res){
            _t.messageShowLoad = false
