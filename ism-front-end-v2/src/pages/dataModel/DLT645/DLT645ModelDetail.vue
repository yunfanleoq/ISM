  ...
  methods: {
    ...
    getSingleModelDetail(){
      ...
      getSnmpModelDetail(params).then(function (res){
        ...
        _t.modbusConnectType = res.data.data.DLT645ConnectType
        setTimeout(function (){
          _t.form.setFieldsValue(
              {
                ...
                DataFormat:res.data.data.DLT645DataFormat,
                configurationModel:res.data.data.configUid,
                configurationPageUUID:res.data.data.PageUUID,
                modbusConnectType:res.data.data.DLT645ConnectType,
              })
          ...
          if(_t.modbusConnectType=="Serial")
          {
            _t.form.setFieldsValue(
                {
                  ModbusType:res.data.data.DLT645ConnectMode,
                  SerialPort:res.data.data.DLT645ConnectCOMName,
                  SerialPortBaud:res.data.data.DLT645SerialBaud.toString(),
                  SerialPortDataBit:res.data.data.DLT645SerialBits.toString(),
                  SerialPortVerifyBit:res.data.data.DLT645SerialParity,
                  SerialPortStopBit:res.data.data.DLT645SerialStopBits,
                  SerialPortFlow:res.data.data.DLT645SerialFlow,
                })
          }
          else
          {
            _t.form.setFieldsValue(
                {
                  IpAddress:res.data.data.DLT645TCPClientIpaddress,
        ...
        if (!err) {
          ...
          const params = {
            ...
            data: {
              ...
              DLT645Timeout:parseInt(this.form.getFieldValue('timeout')),
              DLT645DataFormat:this.form.getFieldValue('DataFormat'),
              configUid:this.form.getFieldValue('configurationModel'),
              PageUUID:this.form.getFieldValue('configurationPageUUID'),
              DLT645TCPClientIpaddress:this.form.getFieldValue('IpAddress'),
              DLT645ConnectType:this.form.getFieldValue('modbusConnectType'),
              DLT645ConnectMode:this.form.getFieldValue('ModbusType'),
              DLT645ConnectCOMName:this.form.getFieldValue('SerialPort'),
              DLT645SerialBaud:parseInt(this.form.getFieldValue('SerialPortBaud')),
              DLT645SerialBits:parseInt(this.form.getFieldValue('SerialPortDataBit')),
              DLT645SerialParity:this.form.getFieldValue('SerialPortVerifyBit'),
              DLT645SerialStopBits:this.form.getFieldValue('SerialPortStopBit'),
              DLT645SerialFlow:this.form.getFieldValue('SerialPortFlow'),
            }
          };
