      ...
      <a-spin style="padding: 1px;"  :spinning="ShowRegisterLoading" tip="Loading...">
        <a-form :form="RegisterForm" layout="vertical" @submit="AddNodeId">
          ...
          <a-row :gutter="16">
            ...
            <a-col :span="12">
              <a-form-item
                  :label="$t('dataModel.DLT645Model.DataFlag')"
              >
                <a-input autocomplete="autocomplete"
                         v-decorator="['DataFlag', {rules: [{ required: true, message: $t('dataModel.DLT645Model.DataFlag'), whitespace: true}]}]"
                />
              </a-form-item>
            </a-col>
          </a-row>
...
export default {
  ...
  data () {
    return {
      ...
      registerGroupColumns: [
        ...
        {
          slotName:this.$t("dataModel.DLT645Model.DataFlag"),
          scopedSlots: {  customRender: 'DataIdentification'  ,title:this.$t("dataModel.DLT645Model.DataFlag")},
          width: '15%',
          align:"left",
          dataIndex: 'DataIdentification'
        },
        {
  ...
  methods: {
        ...
        _t.RegisterForm.setFieldsValue(
            {
              ...
              DataFlag:item.DataIdentification,
        ...
        if (!err) {
          let params = {
            ...
            data: {
              ...
              DataIdentification: this.RegisterForm.getFieldValue('DataFlag'),
          ...
          if (params.data.record==1)
          {
			...
			params.data.RecordDataTimely=this.RegisterForm.getFieldValue('dataRecordExactlyInterval')?this.RegisterForm.getFieldValue('dataRecordExactlyInterval').toString():""
          }
          let _t = this
          DLT645ModelNodeIDEdit(params).then(function (res){
            if(res.data.code==2002)
            {
              ...
              if (target) {
                ...
                target.DataIdentification = _t.RegisterForm.getFieldValue('DataFlag')
                ...
                target.RecordDataTimely=_t.RegisterForm.getFieldValue('dataRecordExactlyInterval')?_t.RegisterForm.getFieldValue('dataRecordExactlyInterval').toString():""
    ...
    NodeIdList(){
      ...
      DLT645ModelNodeIDList(params).then(function (res){
      ...
      this.RegisterForm.validateFields((err) => {
        if (!err) {
          ...
          const params = {
			...
			RecordDataTimely:this.RegisterForm.getFieldValue('dataRecordExactlyInterval')?this.RegisterForm.getFieldValue('dataRecordExactlyInterval').toString():"",
            Description:this.RegisterForm.getFieldValue('NodeIDDec'),
          }
          this.RegisterVisible = false;
          let _t = this
          DLT645ModelNodeIDAdd(params).then(function (res){
            _t.messageShowLoad = false
            if(res.data.code==2002)
            {
              _t.NodeIdList()
    ...
    deleteRecord(uuid,muid) {
      ...
      DLT645ModelNodeIDDel(params).then(function (res) {
