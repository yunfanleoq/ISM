...
<!--    寄存器组表格-->
    <a-card  style="min-height: 400px">
      <a-space class="operator">
        ...
        <a-button type="link">
          <a href="https://www.ismctl.com/soft/OPCUAExplorer.zip">{{$t("dataModel.opcuaModel.ImportTool")}}</a>
        </a-button>
              ...
              <a-row :gutter="16">
                ...
                >
                  ...
                  >
                    ...
                    <a-select-option value="2">SByte</a-select-option>
...
export default {
  ...
  methods: {
    ...
    save() {
      this.RegisterForm.validateFields((err) => {
        if (!err) {
          ...
          let _t = this
          OpcuaModelNodeIDEdit(params).then(function (res){
    ...
    NodeIdList(){
      ...
      OpcuaModelNodeIDList(params).then(function (res){
    ...
    AddNodeId(){
      this.RegisterForm.validateFields((err) => {
        if (!err) {
          ...
          this.RegisterVisible = false;
          let _t = this
          OpcuaModelNodeIDAdd(params).then(function (res){
            _t.messageShowLoad = false
            if(res.data.code==2002)
            {
              _t.NodeIdList()
    ...
    deleteRecord(uuid,muid) {
      ...
      OpcuaModelNodeIDDel(params).then(function (res) {
