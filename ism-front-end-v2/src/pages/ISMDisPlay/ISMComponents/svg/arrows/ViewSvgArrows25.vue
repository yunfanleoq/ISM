<template>
  ...
  <svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none"   x="0px" y="0px"  viewBox="1.235 9.236 41.679 24.07"  xml:space="preserve" :style="{'overflow': 'visible','width':detail.style.position.w,'height':detail.style.position.h,}">
    <g class="svg-el" :style="{'opacity':fillOpacity,'stroke-opacity':strokeOpacity,'stroke':strokeColor,'stroke-width':strokeWidth,'stroke-linecap':'round','stroke-linejoin':'round','fill':fill}">
     <polygon class="color" points="41.497,21.266 34.429,23.037 34.434,31.889 2.652,31.889 2.652,10.654 34.434,10.654 34.434,19.505 41.497,21.266 	"/>
      <!--      闪烁-->
    ...
    data() {
      return {
        ...
        base:{
          ...
          "icon": "data:image/png;base64,",
          "isFontIcon": true,
          "info": {
            "type": "image",
            "action": [],
