<template>
  ...
  <svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none"   x="0px" y="0px" viewBox="1.235 9.236 40.064 29.449"  xml:space="preserve" :style="{'overflow': 'visible','width':detail.style.position.w,'height':detail.style.position.h,}">
    <g class="svg-el" :style="{'opacity':fillOpacity,'stroke-opacity':strokeOpacity,'stroke':strokeColor,'stroke-width':strokeWidth,'stroke-linecap':'round','stroke-linejoin':'round','fill':fill}">
     <polygon class="color" points="39.882,37.268 32.791,31.94 2.652,31.952 2.652,10.654 34.569,10.654 34.569,28.395 39.882,37.268 	"/>
    ...
    data() {
      return {
        ...
        base:{
          ...
          "icon": "data:image/png;base64,",
          "isFontIcon": true,
          "info": {
            "type": "image",
            "action": [],
