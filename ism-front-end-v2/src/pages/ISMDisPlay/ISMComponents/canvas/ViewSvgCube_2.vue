<template>
  ...
  <svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none"   x="0px" y="0px" viewBox="0 1.56 37.66 42.425"   xml:space="preserve" :style="{'overflow': 'visible','width':detail.style.position.w,'height':detail.style.position.h,}">
  ...
  inject: ['getNode'],
    data() {
      return {
        ...
        isStart:false,
        base:{
          "text": "displayConfig.ToolBox.Diagram.Cube2",
          "icon": "data:image/png;base64,",
          "isFontIcon": true,
          "info": {
            "type": "image",
            "action": [],
