<template>
  <svg  xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none"   x="0px" y="0px" viewBox="0 0 32 32" :style="{'overflow': 'visible','width':detail.style.position.w,'height':detail.style.position.h,}">
    <g class="svg-el" :style="{'opacity':fillOpacity,'stroke-opacity':strokeOpacity,'stroke':strokeColor,'stroke-width':strokeWidth,'stroke-linecap':'round','stroke-linejoin':'round','fill':fill}">
      ...
      <circle cx="16" cy="30"  :r="ConnectDiameter" stroke-width="0.0"/>
      <rect :fill="ElectronicDeviceFill" :stroke="strokeColor" :stroke-width="strokeWidth" x="9" y="3" width="15" height="27"/>
...
export default {
  ...
  data() {
    return {
      ...
      fill:"#00FFFF",
      ConnectDiameter:1,
      ElectronicDeviceFill:"transparent",
      strokeWidth:1,
      fillOpacity:1,
      strokeOpacity:1,
      animateType:"blink",
      ...
      base:{
        ...
        "icon": "data:image/png;base64,",
        "isFontIcon": true,
        "info": {
          "type": "image",
          "action": [],
          ...
          "style": {
            ...
            "diy":[
              ...
              {
                "name":"component.Electric.ElectronicDeviceFill",
                "type":2,
                "value":"yellow",
                "key":"ElectronicDeviceFill",
              },
              {
  ...
  methods: {
    initComponents(option){
      ...
      for( i=0;i<option.style.diy.length;i++)
      {
        ...
        else if(option.style.diy[i].key=="ElectronicDeviceFill")
        {
          this.ElectronicDeviceFill=option.style.diy[i].value
        }
