<template>
  ...
  <svg  xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none"   x="0px" y="0px" viewBox="0 0 32 32"   :style="{'overflow': 'visible','width':detail.style.position.w,'height':detail.style.position.h,}">
    ...
    <g class="svg-el" :style="{'opacity':fillOpacity,'stroke-opacity':strokeOpacity,'stroke':strokeColor,'stroke-width':strokeWidth,'stroke-linecap':'round','stroke-linejoin':'round','fill':fill}">
      <circle cx="16" cy="32"  :r="ConnectDiameter" stroke-width="0.0"/>
      <circle cx="16" cy="0"  :r="ConnectDiameter" stroke-width="0.0"/>
      <line :fill="fill" :stroke="strokeColor" :stroke-width="strokeWidth" y1="15" x1="8" y2="15" x2="25"/>
      <line :fill="fill" :stroke="strokeColor" :stroke-width="strokeWidth" y1="22" x1="8" y2="22" x2="25"/>

      <line :fill="fill" :stroke="strokeColor" :stroke-width="strokeWidth" y1="0" x1="16" y2="15" x2="16"/>
      <line :fill="fill" :stroke="strokeColor" :stroke-width="strokeWidth" y1="22" x1="16" y2="32" x2="16"/>
      <!--      闪烁-->
  ...
  data() {
    return {
      ...
      base:{
        ...
        "icon": "data:image/png;base64,",
        "isFontIcon": true,
        "info": {
          "type": "image",
          "action": [],
