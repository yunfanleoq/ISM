<template>
  ...
  <svg  xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none"   x="0px" y="0px" viewBox="0 0 32 32"   :style="{'overflow': 'visible','width':detail.style.position.w,'height':detail.style.position.h,}">
    ...
    <g class="svg-el" :style="{'opacity':fillOpacity,'stroke-opacity':strokeOpacity,'stroke':strokeColor,'stroke-width':strokeWidth,'stroke-linecap':'round','stroke-linejoin':'round','fill':fill}">
      ...
      <line :fill="fill" :stroke="strokeColor" :stroke-width="strokeWidth" x1="16" y1="3" x2="16" y2="16"/>
      <line :fill="fill" :stroke="strokeColor" :stroke-width="strokeWidth" x1="8" y1="16" x2="24" y2="16"/>
      <line :fill="fill" :stroke="strokeColor" :stroke-width="strokeWidth" x1="10" y1="20" x2="22" y2="20"/>
      <line :fill="fill" :stroke="strokeColor" :stroke-width="strokeWidth" x1="12" y1="24" x2="20" y2="24"/>
      <!--      闪烁-->
  ...
  data() {
    return {
      ...
      base:{
        ...
        "icon": "data:image/png;base64,",
        "isFontIcon": true,
        "info": {
          "type": "image",
          "action": [],
          "active": [
            {
              id:"ElectronicClose",
              name:"component.Electric.ElectronicClose",
              result:"",
              isExpression:true,
              condition:{
                deviceSN:"",
