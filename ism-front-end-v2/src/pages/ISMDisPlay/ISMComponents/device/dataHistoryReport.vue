<template>
  ...
  <a-card :bordered="false"  :style="styleVar">
    ...
    <a-spin style="padding: 1px;"  :spinning="messageShowLoad" tip="Loading...">
      <a-table :pagination="pagination" :columns="columns" :data-source="dataSource" rowKey="RecordTime">
...
export default {
  ...
  data () {
    return {
      ...
      selectedRows: [],
      base:{
        text: "configComponent.DataHistoryList.title",
        "icon": "icon-jilu",
        "isFontIcon": true,
        "info": {
          "type": "image",
