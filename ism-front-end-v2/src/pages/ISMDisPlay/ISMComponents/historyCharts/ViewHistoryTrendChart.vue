...
export default {
  ...
  name: 'ism-view-history-trend-chart',
  ...
  data() {
    return {
      ...
      IsShowDate:0,
      base:{
        "text": "configComponent.RealDataChart.HistoryTrendTitle",
        "icon": "icon-icon_qushitu",
        "isFontIcon": true,
        "info": {
  ...
  methods: {
    ...
    timelyTimeGetHistory(){
      ...
      GetChartDataHistoryTrendList(params).then(function (res){
        if(res.data.code==0&&res.data.data!=null)
        {
          ...
          console.log(JSON.stringify(_t.option))
        }
        _t.echartsView.setOption(_t.option,true)
      })
    },
