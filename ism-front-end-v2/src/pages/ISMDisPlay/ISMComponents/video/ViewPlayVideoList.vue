<template>
  ...
  <svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none"  x="0px" y="0px"  xml:space="preserve" :style="{'overflow': 'visible','width':detail.style.position.w,'height':detail.style.position.h,}">
    ...
    <div class="h5videodiv" :style="{'width': width+'px','height': height+'px',}" >
      <LivePlayer :id="detail.identifier" :video-url="video_url"  :video-title="VideoTitle" :alt="VideoTitle+$t('configComponent.video.VideoOfflineTips')" aspect="fullscreen" fluent autoplay live stretch></LivePlayer>
      <div  class="video-close" style="display: none;">关闭</div>
      <div  class="video-close channel-selector" @click="showSystemVideoModel()" >选择通道</div>
    </div>
...
export default {
  ...
  data() {
    return {
      ...
      height:600,
      base:{
        "text": "configComponent.video.videoList",
        "icon": "icon-shipin",
        "isFontIcon": true,
        "info": {
          "type": "image",
