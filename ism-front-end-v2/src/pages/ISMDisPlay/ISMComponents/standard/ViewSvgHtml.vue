        ...
        <div :style="animatedStyle" v-show="detail.style.visible==1 ||isStart? true:false">
          <div :class="{
               ...
               :style="{
                ...
                <div v-html="htmlData" style="width: 100%; height: 100%;"></div>
          </div>
        </div>
      </foreignObject>
<!--      闪烁-->
  ...
  mixins: [ISMChildAutoMixin],
    ...
    data() {
      return {
        ...
        htmlData:"html网页",
        base:{
          text: "configComponent.html.Text",
          "icon": "icon-html1",
          "isFontIcon": true,
          "info": {
            "type": "image",
            ...
            "style": {
              ...
              "diy":[
                {
                  "name":"configComponent.html.HtmlData",
                  "type":11,
                  "value":"html 代码 组件",
                  "rows":30,
                  "key":"HtmlData",
    ...
    methods: {
      initComponents(option){
        ...
        {
          if(option.style.diy[i].key=="HtmlData")
          {
            this.htmlData=option.style.diy[i].value
          }
        }
        i=0
