...
export default {
  ...
  data() {
    return {
      ...
      ShowDataResult:0,
        base:{
          "text": "configComponent.humidityGauge.title",
          "icon": "icon-wenshiduchuanganqi",
          "isFontIcon": true,
          "info": {
            "type": "chart-gauge",
            "action": [],
  ...
  methods: {
    initComponents(option){
      ...
      this.option.width=this.detail.style.position.w-this.detail.style.borderWidth*2
      this.option.height=this.detail.style.position.h-this.detail.style.borderWidth*2
