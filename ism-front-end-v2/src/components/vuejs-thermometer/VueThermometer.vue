<template>
  <div class="vue-thermometer" :class="customClass">
    ...
    <g>
      ...
      <text   :x="baseXOffset" :y="thermoOffset-5" fill="defaultOptions.text.color" :font-size="defaultOptions.text.fontSize" :font-family="defaultOptions.text.fontFamily">{{value}}{{ scale}}</text>
    ...
    options: {
      handler(newVal, oldVal) {
        if (newVal !== null && newVal !== undefined) {
          this.mergeDefaultOptionsWithProp(newVal)
        }
      },
      deep: true
    }
