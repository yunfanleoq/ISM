...
// 属性字段
const (
	Field_Rtd      string = "Rtd"
	Field_Flag     string = "Flag"
	Field_Cou      string = "Cou"
	Field_Min      string = "Min"
	Field_Avg      string = "Avg"
	Field_Max      string = "Max"
	Field_DataTime string = "DataTime"
)
