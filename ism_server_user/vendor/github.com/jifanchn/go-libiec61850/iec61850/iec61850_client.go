...
func (client *IedClient) WirteBoolean(objectRef string, constraint FunctionalConstraint, setvalue bool) C.IedClientError {
	cObjectRef := C.CString(objectRef)
	defer C.free(unsafe.Pointer(cObjectRef))

	var clientError C.IedClientError
	C.IedConnection_writeBooleanValue(client.connection, &clientError, cObjectRef, C.FunctionalConstraint(constraint), C.bool(setvalue))
...
func (client *IedClient) WirteFloat(objectRef string, constraint FunctionalConstraint, setvalue float32) C.IedClientError {
	cObjectRef := C.CString(objectRef)
	defer C.free(unsafe.Pointer(cObjectRef))

	var clientError C.IedClientError
	C.IedConnection_writeFloatValue(client.connection, &clientError, cObjectRef, C.FunctionalConstraint(constraint), C.float(setvalue))
...
func (client *IedClient) WirteVisibleString(objectRef string, constraint FunctionalConstraint, setvalue string) C.IedClientError {
	cObjectRef := C.CString(objectRef)
	defer C.free(unsafe.Pointer(cObjectRef))

	var clientError C.IedClientError
	C.IedConnection_writeVisibleStringValue(client.connection, &clientError, cObjectRef, C.FunctionalConstraint(constraint), C.CString(setvalue))
...
func (client *IedClient) WirteInt32(objectRef string, constraint FunctionalConstraint, setvalue int32) C.IedClientError {
	cObjectRef := C.CString(objectRef)
	defer C.free(unsafe.Pointer(cObjectRef))

	var clientError C.IedClientError
	C.IedConnection_writeInt32Value(client.connection, &clientError, cObjectRef, C.FunctionalConstraint(constraint), C.int32_t(setvalue))
...
func (client *IedClient) WirteUnsigned32(objectRef string, constraint FunctionalConstraint, setvalue uint32) C.IedClientError {
	cObjectRef := C.CString(objectRef)
	defer C.free(unsafe.Pointer(cObjectRef))

	var clientError C.IedClientError
	C.IedConnection_writeUnsigned32Value(client.connection, &clientError, cObjectRef, C.FunctionalConstraint(constraint), C.uint32_t(setvalue))
