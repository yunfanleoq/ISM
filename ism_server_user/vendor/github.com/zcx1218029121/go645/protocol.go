...
func Bytes2Int(data []byte) int32 {
	var dateCode int32 = 0
	var dataCode1 int32 = int32(data[3])
	var dataCode2 int32 = int32(data[2])
	var dataCode3 int32 = int32(data[1])
	var dataCode4 int32 = int32(data[0])
	dateCode = (dataCode1 << 24) | (dataCode2 << 16) | (dataCode3 << 8) | dataCode4
	return dateCode
}
