...
export default class TableView extends React.Component<TableViewProps, object> {
    ...
    renderTd(td: TdObject, colIndex: number, rowIndex: number): React.JSX.Element;
    renderTdBody(body?: SchemaObject): JSX.Element;
    renderTds(tds: TdObject[], rowIndex: number): React.JSX.Element[];
    renderTr(tr: TrObject, rowIndex: number): React.JSX.Element;
    renderTrs(trs: TrObject[]): React.JSX.Element[];
