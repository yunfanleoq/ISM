...
type DLT645DeviceModelController struct {
	beego.Controller
}

func (c *DLT645DeviceModelController) ModelList() {
...
func (c *DLT645DeviceModelController) ModelAdd() {
...
func (c *DLT645DeviceModelController) ModelDel() {
	...
	if err != nil {
		...
		code = models.Dlt645ModelDel(delModel.Uuid)
	}
	ProjectUuid := c.Ctx.Request.Header.Get("ProjectUuid")
	WriteOperationJournal(c.Ctx.Request.Header.Get("Authorization"), ProjectUuid, "删除了DLT645模型", errmsg.JournalLevelInfo, c.Ctx.Input)
	result := map[string]interface{}{
		"code": code,
	}
...
func (c *DLT645DeviceModelController) ModelEdit() {
	...
	ProjectUuid := c.Ctx.Request.Header.Get("ProjectUuid")
	WriteOperationJournal(c.Ctx.Request.Header.Get("Authorization"), ProjectUuid, "编辑了DLT645 模型"+update.Data.Name, errmsg.JournalLevelInfo, c.Ctx.Input)
	result := map[string]interface{}{
		"code": code,
	}
...
func (c *DLT645DeviceModelController) ModelDataAdd() {

	var addData models.Dlt645DevicesDataModel
	var code int
	...
	if err != nil {
		...
		code = models.DLT645NodeAdd(addData)
		ProjectUuid := c.Ctx.Request.Header.Get("ProjectUuid")
		WriteOperationJournal(c.Ctx.Request.Header.Get("Authorization"), ProjectUuid, "添加了DLT645模型数据"+addData.Name, errmsg.JournalLevelInfo, c.Ctx.Input)
	}
...
func (c *DLT645DeviceModelController) ModelDataDel() {
	...
	if err != nil {
		...
		code = models.DLT645NodeDel(delData.Uuid)
		ProjectUuid := c.Ctx.Request.Header.Get("ProjectUuid")
...
func (c *DLT645DeviceModelController) ModelDataEdit() {

	type EditStu struct {
		Muid string                        `json:"muid"`
		Uuid string                        `json:"uuid"`
		Data models.Dlt645DevicesDataModel `json:"data"`
	}
	...
	if err != nil {
		...
		code = models.DLT645NodeEdit(EditData.Muid, EditData.Uuid, EditData.Data)
		ProjectUuid := c.Ctx.Request.Header.Get("ProjectUuid")
...
func (c *DLT645DeviceModelController) ModelDataList() {

	var muid map[string]interface{}
	var code int
	var Nodelist []models.Dlt645DevicesDataModel
	dataJson := c.Ctx.Input.RequestBody
	...
	if err != nil {
		...
		Nodelist = models.DLT645NodeList(muid["muid"].(string))
	}
	result := map[string]interface{}{
		"code": code,
		"list": Nodelist,
